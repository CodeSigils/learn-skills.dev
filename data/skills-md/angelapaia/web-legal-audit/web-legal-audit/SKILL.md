...
Confirma el directorio de salida. Default: `IA Masters/99-Legal/auditorias/<dominio>-<YYYY-MM-DD>/`
...
Archiva todo en la carpeta definida en Fase 1. Abre el docx al terminar y ofrece enviarlo por WhatsApp si el usuario tiene esa skill disponible.
...
- `web-security-audit` → **NO usar en lugar de esta skill**; complementaria si el usuario pide análisis técnico de vulnerabilidades (OWASP, CVE)

## Estructura de archivos generados

```
IA Masters/99-Legal/auditorias/<dominio>-<YYYY-MM-DD>/
