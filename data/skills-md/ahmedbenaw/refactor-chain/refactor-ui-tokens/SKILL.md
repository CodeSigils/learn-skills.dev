...
## Chain position
First step of the do-the-work UI lane. Fed by plan (or entered cold). Feeds refactor-ui-visual (web) or refactor-ui-mobile (native) with a stable token vocabulary, then refactor-ui-components, refactor-ui-a11y, and finally refactor-code-solid + the review gate.
