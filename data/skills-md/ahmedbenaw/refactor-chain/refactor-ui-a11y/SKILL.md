...
## Chain position
Closing **gate** of the do-the-work UI lane, after refactor-ui-components. Must pass before the lane advances to refactor-code-solid and the final review gate. Complements refactor-security/performance/red-team, which review correctness and safety of the whole diff.
