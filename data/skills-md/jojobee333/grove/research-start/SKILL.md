...
3. Write `00-intake/brief.md` from their answers using this structure:

```markdown
# Research Brief — [Topic Name]

**Main research question:** [from user]
**Output will be used for:** [from user]
**Output audience:** [from user]
**Constraints:** [deadline, source requirements, topics to avoid — from user]
**Output format requested:** [report / summary / both / other]
```
