...
**Available commands** (see `commands/` directory for details):
- `/power-engineer:power-engineer` — full 8-question interview
...
- `/power-engineer:update` — find and install new skills since last setup
