...
`npx skills` 只安裝本 skill，不會安裝 Claude Code plugin。自動通知由
[`custom-skills-notify` plugin](https://github.com/ValorVie/custom-skills/tree/main/plugins/custom-skills-notify)
處理，監聽以下 Claude Code hook 事件：
