...
NNNN. Idea title exactly as the user said it
	source: <source-repo>, Cursor chat "Chat title", 2026-07-15
...
69. Idea title — one-line explanation in the user's voice.
    - source: <source-repo>, Cursor chat "Chat title", 2026-08-01
```
...
- All idea capture was centralized into `<ideas-repo>` on 2026-08-14 (the user's decision). The old startup repo is frozen pending archive — NEVER write or push there. Startup support material now lives in `<ideas-repo>/startup/`.
