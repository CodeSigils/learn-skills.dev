...
- Stitch SDK usage and installation documentation: `https://stitch-designer.ai/docs/sdk/ai-sdk`
- DESIGN.md documentation and examples: `https://stitch-designer.ai/docs/design-md/overview`
