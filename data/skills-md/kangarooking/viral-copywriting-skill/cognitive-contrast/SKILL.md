...
description: |
  当用户需要放大产品相对于竞品的优势时，调用此 skill。核心操作是先描述竞品差+利益少，再描述自己好+利益大，利用心理学对比原理制造心理落差。特别适用于成熟品类中"在某些方面更好"的产品。不适用于全新品类（没有竞品可对比）、也不适用于品牌形象广告（对比显得格局低）。关键触发信号：用户提到"产品比竞品好但读者感知不到""怎么突出差异化优势""卖点太平淡想放大效果"。
source_book: 《爆款文案》 关健明
source_chapter: 第一章 1.3 认知对比
tags: [对比原理, 竞品分析, 差异化, 购买欲激发, 心理落差]
related_skills: [copywriting-four-step-system, fear-appeal, sensory-occupation]
---
