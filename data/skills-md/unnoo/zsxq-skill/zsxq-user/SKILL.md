...
name: zsxq-user
version: 1.1.0
description: "知识星球用户信息：查看当前登录用户的个人资料、浏览跨星球的最近主题足迹。当用户需要查看自己的用户 ID、昵称、头像、认证状态，或查看自己最近在各星球的浏览记录时使用。"
metadata:
  requires:
    bins: ["zsxq-cli"]
...
| [`+footprints`](references/zsxq-user-footprints.md) | 查看自己在所有星球的最近主题足迹，支持分页 |
