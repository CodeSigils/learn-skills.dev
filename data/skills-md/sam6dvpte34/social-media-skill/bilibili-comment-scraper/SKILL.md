---
name: bilibili-comment-scraper
description: "Collect comments from Bilibili — text, author, timestamp, likes, replies. Use when the user wants to mine audience feedback, questions, or sentiment."
license: MIT
metadata:
...
Use this Skill for Bilibili comment collection, research, monitoring, analysis, and export.
...
- Collect comments, nested replies, authors, timestamps, likes, and creator responses
- Research and compare comment across selected Bilibili targets
...
- "Use bilibili-comment-scraper to collect comments, nested replies, authors, timestamps, likes, and creator responses."
- "Collect visible Bilibili comment data for these URLs or targets and export a CSV."
- "Research this Bilibili comment workflow and include the relevant fields and source links."
- "Monitor these Bilibili targets for comment changes and return a structured comparison."
