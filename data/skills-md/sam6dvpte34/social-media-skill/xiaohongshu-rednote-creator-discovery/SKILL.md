---
name: xiaohongshu-rednote-creator-discovery
description: "Collect creator discovery from Xiaohongshu (RedNote) — matching creators, follower counts, niches. Use when the user wants to find creators by niche, region, or audience size."
license: MIT
metadata:
...
Use this Skill for Xiaohongshu / RedNote creator discovery collection, research, monitoring, analysis, and export.
...
- Discover creators by niche, keyword, location, content, and engagement signals
- Research and compare creator discovery across selected Xiaohongshu / RedNote targets
...
1. Identify the target Xiaohongshu / RedNote profile, handle, account list, niche, keyword, or discovery criteria.
...
- "Use xiaohongshu-rednote-creator-discovery to discover creators by niche, keyword, location, content, and engagement signals."
- "Collect visible Xiaohongshu / RedNote creator discovery data for these URLs or targets and export a CSV."
- "Research this Xiaohongshu / RedNote creator discovery workflow and include the relevant fields and source links."
- "Monitor these Xiaohongshu / RedNote targets for creator discovery changes and return a structured comparison."
