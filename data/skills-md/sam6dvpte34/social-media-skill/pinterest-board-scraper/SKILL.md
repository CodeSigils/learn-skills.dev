...
description: "Collect boards from Pinterest — board title, pins, category, curator. Use when the user wants to research board curation or content collections."
license: MIT
metadata:
...
Use this Skill for Pinterest board collection, research, monitoring, analysis, and export.
...
- Collect board metadata, owners, descriptions, follower counts, and ordered Pins
- Research and compare board across selected Pinterest targets
- Monitor visible activity, changes, and engagement signals over repeated collections
- Export structured, source-linked board records for analysis or operations
...
1. Identify the target Pinterest board, Pin, profile, keyword, or category page.
...
- "Use pinterest-board-scraper to collect board metadata, owners, descriptions, follower counts, and ordered Pins."
- "Collect visible Pinterest board data for these URLs or targets and export a CSV."
- "Research this Pinterest board workflow and include the relevant fields and source links."
- "Monitor these Pinterest targets for board changes and return a structured comparison."
