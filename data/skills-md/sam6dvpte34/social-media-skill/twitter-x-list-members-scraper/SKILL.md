---
name: twitter-x-list-members-scraper
description: "Collect Twitter list members from Twitter/X — usernames, profiles, bios. Use when the user wants to map an audience or build lists from a curated list."
license: MIT
metadata:
...
Use this Skill for Twitter/X list members collection, research, monitoring, analysis, and export.
...
- Collect public list metadata and visible member profiles
- Research and compare list members across selected Twitter/X targets
- Monitor visible activity, changes, and engagement signals over repeated collections
- Export structured, source-linked list members records for analysis or operations
...
- "Use twitter-x-list-members-scraper to collect public list metadata and visible member profiles."
- "Collect visible Twitter/X list members data for these URLs or targets and export a CSV."
- "Research this Twitter/X list members workflow and include the relevant fields and source links."
- "Monitor these Twitter/X targets for list members changes and return a structured comparison."
