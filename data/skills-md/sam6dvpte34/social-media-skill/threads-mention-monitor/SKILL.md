---
name: threads-mention-monitor
description: "Collect mention monitoring from Threads — mentioning posts, authors, timestamps. Use when the user wants to track brand or handle mentions."
license: MIT
metadata:
...
Use this Skill for Threads mention monitor collection, research, monitoring, analysis, and export.
...
- Monitor new public mentions of brands, products, people, or keywords
- Research and compare mention monitor across selected Threads targets
- Monitor visible activity, changes, and engagement signals over repeated collections
- Export structured, source-linked mention monitor records for analysis or operations
...
- "Use threads-mention-monitor to monitor new public mentions of brands, products, people, or keywords."
- "Collect visible Threads mention monitor data for these URLs or targets and export a CSV."
- "Research this Threads mention monitor workflow and include the relevant fields and source links."
- "Monitor these Threads targets for mention monitor changes and return a structured comparison."
