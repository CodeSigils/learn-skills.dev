---
name: facebook-video-scraper
description: "Collect videos from Facebook — title, views, likes, comments, creator. Use when the user wants to research video content, track creators, or benchmark performance."
license: MIT
metadata:
...
Use this Skill for Facebook video collection, research, monitoring, analysis, and export.
...
- Collect public video metadata, descriptions, pages, dates, views, and engagement
- Research and compare video across selected Facebook targets
...
- "Use facebook-video-scraper to collect public video metadata, descriptions, pages, dates, views, and engagement."
- "Collect visible Facebook video data for these URLs or targets and export a CSV."
- "Research this Facebook video workflow and include the relevant fields and source links."
- "Monitor these Facebook targets for video changes and return a structured comparison."
