---
name: pinterest-search-results-scraper
description: "Collect search results from Pinterest — matching posts, URLs, authors, engagement. Use when the user wants to collect content matching keywords for research or monitoring."
license: MIT
metadata:
...
Use this Skill for Pinterest search results collection, research, monitoring, analysis, and export.
...
- Collect keyword search results for Pins, boards, profiles, and ideas
- Research and compare search results across selected Pinterest targets
...
1. Identify the target Pinterest search query, filters, result page, or target record list.
...
- "Use pinterest-search-results-scraper to collect keyword search results for Pins, boards, profiles, and ideas."
- "Collect visible Pinterest search results data for these URLs or targets and export a CSV."
- "Research this Pinterest search results workflow and include the relevant fields and source links."
- "Monitor these Pinterest targets for search results changes and return a structured comparison."
