---
name: bluesky-post-scraper
description: "Collect posts from Bluesky — text, images, likes, comments, timestamps. Use when the user wants to research content, track publishing activity, or export post datasets."
license: MIT
metadata:
...
Use this Skill for Bluesky post collection, research, monitoring, analysis, and export.
...
- Collect posts, embeds, links, timestamps, likes, replies, and reposts
- Research and compare post across selected Bluesky targets
...
- "Use bluesky-post-scraper to collect posts, embeds, links, timestamps, likes, replies, and reposts."
- "Collect visible Bluesky post data for these URLs or targets and export a CSV."
- "Research this Bluesky post workflow and include the relevant fields and source links."
- "Monitor these Bluesky targets for post changes and return a structured comparison."
