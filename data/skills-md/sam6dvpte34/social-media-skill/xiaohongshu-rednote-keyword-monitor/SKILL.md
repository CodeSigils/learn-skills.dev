---
name: xiaohongshu-rednote-keyword-monitor
description: "Collect keyword monitoring from Xiaohongshu (RedNote) — matching posts, sources, timestamps, engagement. Use when the user wants to track brand names, product mentions, or campaigns over time."
license: MIT
metadata:
...
Use this Skill for Xiaohongshu / RedNote keyword monitor collection, research, monitoring, analysis, and export.
...
- Monitor new notes and comments for keyword sets, aliases, and competitor names
- Research and compare keyword monitor across selected Xiaohongshu / RedNote targets
...
- "Use xiaohongshu-rednote-keyword-monitor to monitor new notes and comments for keyword sets, aliases, and competitor names."
- "Collect visible Xiaohongshu / RedNote keyword monitor data for these URLs or targets and export a CSV."
- "Research this Xiaohongshu / RedNote keyword monitor workflow and include the relevant fields and source links."
- "Monitor these Xiaohongshu / RedNote targets for keyword monitor changes and return a structured comparison."
