...
description: "Collect search results from YouTube — matching posts, URLs, authors, engagement. Use when the user wants to collect content matching keywords for research or monitoring."
license: MIT
metadata:
...
Use this Skill for YouTube search research, creator discovery, topic monitoring, and keyword-based content intelligence on YouTube.
...
- Collect YouTube keyword search results for videos, channels, playlists, or live streams
...
- Video or channel title, creator, description snippet, and publication context
- Views, duration, subscriber count when visible, and engagement signals
- Search filters, pagination context, and collection timestamp

## Instructions

1. Identify the target YouTube search query, keyword list, channel query, or topic phrase.
...
- "Scrape YouTube search results for these keywords."
- "Find YouTube channels and videos for this software category."
- "Collect YouTube search results with titles, creators, views, and URLs."
- "Monitor YouTube search results for these brand and competitor terms."
