---
name: tiktok-live-room-scraper
description: "Collect live rooms from TikTok — host, viewers, title, category, chat. Use when the user wants to track live streams, monitor promotions, or research hosts."
license: MIT
metadata:
...
Use this Skill for TikTok live room collection, research, monitoring, analysis, and export.
...
- Collect authorized live-room metadata, host details, viewers, products, and chat samples
- Research and compare live room across selected TikTok targets
...
1. Identify the target TikTok live room, stream, Space, channel, host, schedule, or category page.
...
- "Use tiktok-live-room-scraper to collect authorized live-room metadata, host details, viewers, products, and chat samples."
- "Collect visible TikTok live room data for these URLs or targets and export a CSV."
- "Research this TikTok live room workflow and include the relevant fields and source links."
- "Monitor these TikTok targets for live room changes and return a structured comparison."
