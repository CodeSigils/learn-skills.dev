---
name: pinterest-pin-scraper
description: "Collect pins from Pinterest — title, description, image, saves, source. Use when the user wants to collect pin details for research or inspiration."
license: MIT
metadata:
...
Use this Skill for Pinterest pin collection, research, monitoring, analysis, and export.
...
- Collect Pin titles, descriptions, images, links, topics, saves, and creator data
- Research and compare pin across selected Pinterest targets
- Monitor visible activity, changes, and engagement signals over repeated collections
- Export structured, source-linked pin records for analysis or operations
...
- "Use pinterest-pin-scraper to collect Pin titles, descriptions, images, links, topics, saves, and creator data."
- "Collect visible Pinterest pin data for these URLs or targets and export a CSV."
- "Research this Pinterest pin workflow and include the relevant fields and source links."
- "Monitor these Pinterest targets for pin changes and return a structured comparison."
