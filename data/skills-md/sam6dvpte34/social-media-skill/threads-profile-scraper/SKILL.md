...
description: "Collect profile pages from Threads — username, bio, followers, posts count, website. Use when the user wants to research creators, find influencers, or build lead lists."
license: MIT
metadata:
...
Use this Skill for Threads profile collection, research, monitoring, analysis, and export.
...
- Collect public profiles, bios, follower counts, links, verification, and recent activity
- Research and compare profile across selected Threads targets
...
1. Identify the target Threads profile, handle, account list, niche, keyword, or discovery criteria.
...
- "Use threads-profile-scraper to collect public profiles, bios, follower counts, links, verification, and recent activity."
- "Collect visible Threads profile data for these URLs or targets and export a CSV."
- "Research this Threads profile workflow and include the relevant fields and source links."
- "Monitor these Threads targets for profile changes and return a structured comparison."
