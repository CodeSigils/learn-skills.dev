---
name: zhihu-comment-scraper
description: "Collect comments from Zhihu — text, author, timestamp, likes, replies. Use when the user wants to mine audience feedback, questions, or sentiment."
license: MIT
metadata:
...
Use this Skill for Zhihu comment collection, research, monitoring, analysis, and export.
...
- Collect answer comments, replies, authors, timestamps, and likes
- Research and compare comment across selected Zhihu targets
...
1. Identify the target Zhihu post, video, article, thread, live page, or source URL containing the target discussion.
...
- "Use zhihu-comment-scraper to collect answer comments, replies, authors, timestamps, and likes."
- "Collect visible Zhihu comment data for these URLs or targets and export a CSV."
- "Research this Zhihu comment workflow and include the relevant fields and source links."
- "Monitor these Zhihu targets for comment changes and return a structured comparison."
