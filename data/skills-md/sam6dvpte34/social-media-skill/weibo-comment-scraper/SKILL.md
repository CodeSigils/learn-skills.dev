...
description: "Collect comments from Weibo — text, author, timestamp, likes, replies. Use when the user wants to mine audience feedback, questions, or sentiment."
license: MIT
metadata:
...
Use this Skill for Weibo comment collection, research, monitoring, analysis, and export.
...
- Collect comments, replies, authors, timestamps, locations when visible, and likes
- Research and compare comment across selected Weibo targets
...
1. Identify the target Weibo post, video, article, thread, live page, or source URL containing the target discussion.
...
- "Use weibo-comment-scraper to collect comments, replies, authors, timestamps, locations when visible, and likes."
- "Collect visible Weibo comment data for these URLs or targets and export a CSV."
- "Research this Weibo comment workflow and include the relevant fields and source links."
- "Monitor these Weibo targets for comment changes and return a structured comparison."
