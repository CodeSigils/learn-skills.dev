...
description: "Collect shorts from YouTube — title, views, likes, creator. Use when the user wants to research short-form video or track shorts performance."
license: MIT
metadata:
...
Use this Skill for YouTube shorts collection, research, monitoring, analysis, and export.
...
- Collect Shorts metadata, creators, descriptions, visible music labels, views, likes, and comments
- Research and compare shorts across selected YouTube targets
- Monitor visible activity, changes, and engagement signals over repeated collections
- Export structured, source-linked shorts records for analysis or operations
...
- "Use youtube-shorts-scraper to collect Shorts metadata, creators, descriptions, visible music labels, views, likes, and comments."
- "Collect visible YouTube shorts data for these URLs or targets and export a CSV."
- "Research this YouTube shorts workflow and include the relevant fields and source links."
- "Monitor these YouTube targets for shorts changes and return a structured comparison."
