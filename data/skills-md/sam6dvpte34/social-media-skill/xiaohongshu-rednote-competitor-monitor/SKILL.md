---
name: xiaohongshu-rednote-competitor-monitor
description: "Collect competitor accounts from Xiaohongshu (RedNote) — posts, engagement, publishing cadence, themes. Use when the user wants to track competitor content and posting activity."
license: MIT
metadata:
...
Use this Skill for Xiaohongshu / RedNote competitor monitor collection, research, monitoring, analysis, and export.
...
- Track competitor profiles, new notes, topics, and engagement changes
- Research and compare competitor monitor across selected Xiaohongshu / RedNote targets
- Monitor visible activity, changes, and engagement signals over repeated collections
- Export structured, source-linked competitor monitor records for analysis or operations
...
- "Use xiaohongshu-rednote-competitor-monitor to track competitor profiles, new notes, topics, and engagement changes."
- "Collect visible Xiaohongshu / RedNote competitor monitor data for these URLs or targets and export a CSV."
- "Research this Xiaohongshu / RedNote competitor monitor workflow and include the relevant fields and source links."
- "Monitor these Xiaohongshu / RedNote targets for competitor monitor changes and return a structured comparison."
