---
name: threads-reply-scraper
description: "Collect replies from Threads — reply text, author, timestamp, thread context. Use when the user wants to collect reply threads for discussion analysis."
license: MIT
metadata:
...
Use this Skill for Threads reply collection, research, monitoring, analysis, and export.
...
- Collect reply trees, authors, timestamps, depth, likes, and conversation context
- Research and compare reply across selected Threads targets
...
1. Identify the target Threads post, video, article, thread, live page, or source URL containing the target discussion.
...
- "Use threads-reply-scraper to collect reply trees, authors, timestamps, depth, likes, and conversation context."
- "Collect visible Threads reply data for these URLs or targets and export a CSV."
- "Research this Threads reply workflow and include the relevant fields and source links."
- "Monitor these Threads targets for reply changes and return a structured comparison."
