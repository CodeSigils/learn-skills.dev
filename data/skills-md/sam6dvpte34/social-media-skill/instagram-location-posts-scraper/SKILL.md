...
description: "Collect posts by location from Instagram — posts, media, engagement, author, location. Use when the user wants to research content tied to a place or run location-based campaigns."
license: MIT
metadata:
...
Use this Skill for Instagram location posts collection, research, monitoring, analysis, and export.
...
- Collect public posts and Reels associated with a visible location page
- Research and compare location posts across selected Instagram targets
- Monitor visible activity, changes, and engagement signals over repeated collections
- Export structured, source-linked location posts records for analysis or operations
...
1. Identify the target Instagram location page, place name, location query, or related content URL.
...
- "Use instagram-location-posts-scraper to collect public posts and Reels associated with a visible location page."
- "Collect visible Instagram location posts data for these URLs or targets and export a CSV."
- "Research this Instagram location posts workflow and include the relevant fields and source links."
- "Monitor these Instagram targets for location posts changes and return a structured comparison."
