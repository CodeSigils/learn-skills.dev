---
name: instagram-follower-list-scraper
description: "Collect follower lists from Instagram — follower usernames, profile links, bios. Use when the user wants to map an account's audience or export follower lists for research."
license: MIT
metadata:
...
Use this Skill for Instagram follower list collection, research, monitoring, analysis, and export.
...
- Research and compare follower list across selected Instagram targets
...
- "Use instagram-follower-list-scraper to collect visible followers from accounts the user is authorized to access."
- "Collect visible Instagram follower list data for these URLs or targets and export a CSV."
- "Research this Instagram follower list workflow and include the relevant fields and source links."
- "Monitor these Instagram targets for follower list changes and return a structured comparison."
