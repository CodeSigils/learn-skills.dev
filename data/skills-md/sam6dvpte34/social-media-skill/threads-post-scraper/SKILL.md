...
description: "Collect posts from Threads — text, images, likes, comments, timestamps. Use when the user wants to research content, track publishing activity, or export post datasets."
license: MIT
metadata:
...
Use this Skill for Threads post collection, research, monitoring, analysis, and export.
...
- Collect posts, media, timestamps, mentions, links, likes, replies, and reposts
- Research and compare post across selected Threads targets
...
1. Identify the target Threads URL, account, content page, keyword, category, or target list.
...
- "Use threads-post-scraper to collect posts, media, timestamps, mentions, links, likes, replies, and reposts."
- "Collect visible Threads post data for these URLs or targets and export a CSV."
- "Research this Threads post workflow and include the relevant fields and source links."
- "Monitor these Threads targets for post changes and return a structured comparison."
