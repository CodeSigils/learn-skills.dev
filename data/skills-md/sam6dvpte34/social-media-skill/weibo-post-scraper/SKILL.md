---
name: weibo-post-scraper
description: "Collect posts from Weibo — text, images, likes, comments, timestamps. Use when the user wants to research content, track publishing activity, or export post datasets."
license: MIT
metadata:
...
Use this Skill for Weibo post collection, research, monitoring, analysis, and export.
...
- Collect posts, reposts, media, topics, mentions, timestamps, and engagement
- Research and compare post across selected Weibo targets
- Monitor visible activity, changes, and engagement signals over repeated collections
- Export structured, source-linked post records for analysis or operations
...
1. Identify the target Weibo URL, account, content page, keyword, category, or target list.
...
- "Use weibo-post-scraper to collect posts, reposts, media, topics, mentions, timestamps, and engagement."
- "Collect visible Weibo post data for these URLs or targets and export a CSV."
- "Research this Weibo post workflow and include the relevant fields and source links."
- "Monitor these Weibo targets for post changes and return a structured comparison."
