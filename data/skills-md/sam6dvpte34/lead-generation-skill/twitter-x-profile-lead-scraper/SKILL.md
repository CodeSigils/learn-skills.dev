---
name: twitter-x-profile-lead-scraper
description: "Collect lead details from Twitter/X profiles — username, bio, followers, website, contact signals. Use when the user wants to research or enrich Twitter/X accounts as prospects."
license: MIT
metadata:
...
Use this Skill for twitter/x profile lead scraper.
...
- "Run twitter/x profile lead scraper and export the results to a CSV."
- "Collect twitter/x profile lead data from this URL and return a table."
- "Find visible contact details using twitter/x profile lead scraper for this list of targets."
- "Research these targets with twitter/x profile lead scraper and return name, contact, source URL, and any visible signals."
