---
name: google-maps-website-contact-extractor
description: "Extract website contact details from Google Maps listings — business name, website URL, found email, phone. Use when the user wants to visit listed websites and collect contact information."
license: MIT
metadata:
...
Use this Skill for google maps website contact extractor on Google Maps.
...
- "Run google maps website contact extractor and export the results to a CSV."
- "Collect google maps website contact extractor data from this URL and return a table."
- "Find visible contact details using google maps website contact extractor for this list of targets."
- "Research these targets with google maps website contact extractor and return name, contact, source URL, and any visible signals."
