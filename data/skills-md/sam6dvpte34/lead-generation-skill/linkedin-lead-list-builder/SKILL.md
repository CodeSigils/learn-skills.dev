...
description: "Build a lead list from LinkedIn search results — name, title, company, location, profile URL, contact signals. Use when the user wants to export a structured prospect list from LinkedIn."
license: MIT
metadata:
...
Use this Skill for linkedin lead list builder on LinkedIn.
...
- "Run linkedin lead list builder and export the results to a CSV."
- "Collect linkedin lead list builder data from this URL and return a table."
- "Find visible contact details using linkedin lead list builder for this list of targets."
- "Research these targets with linkedin lead list builder and return name, contact, source URL, and any visible signals."
