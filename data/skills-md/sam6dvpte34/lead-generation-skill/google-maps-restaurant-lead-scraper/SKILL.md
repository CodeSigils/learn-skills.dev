---
name: google-maps-restaurant-lead-scraper
description: "Collect restaurant leads from Google Maps — restaurant name, cuisine, address, phone, website, rating. Use when the user wants to prospect restaurants for B2B services."
license: MIT
metadata:
...
Use this Skill for google maps restaurant lead scraper on Google Maps.
...
- "Run google maps restaurant lead scraper and export the results to a CSV."
- "Collect google maps restaurant lead data from this URL and return a table."
- "Find visible contact details using google maps restaurant lead scraper for this list of targets."
- "Research these targets with google maps restaurant lead scraper and return name, contact, source URL, and any visible signals."
