---
name: twitter-x-business-contact-search
description: "Search for business contact signals on Twitter/X — username, bio email, website, company, contact links. Use when the user wants to find contact information for business accounts on Twitter/X."
license: MIT
metadata:
...
# Twitter/X Business Contact Search

Use this Skill for twitter/x business contact search.
...
- "Run twitter/x business contact search and export the results to a CSV."
- "Collect twitter/x business contact data from this URL and return a table."
- "Find visible contact details using twitter/x business contact search for this list of targets."
- "Research these targets with twitter/x business contact search and return name, contact, source URL, and any visible signals."
