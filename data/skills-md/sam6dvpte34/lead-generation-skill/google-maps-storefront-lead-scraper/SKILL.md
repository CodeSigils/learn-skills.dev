---
name: google-maps-storefront-lead-scraper
description: "Collect storefront business leads from Google Maps — business name, address, phone, website, hours, rating. Use when the user wants to build a physical retail or storefront prospect list."
license: MIT
metadata:
...
Use this Skill for google maps storefront lead scraper on Google Maps.
...
- "Run google maps storefront lead scraper and export the results to a CSV."
- "Collect google maps storefront lead data from this URL and return a table."
- "Find visible contact details using google maps storefront lead scraper for this list of targets."
- "Research these targets with google maps storefront lead scraper and return name, contact, source URL, and any visible signals."
