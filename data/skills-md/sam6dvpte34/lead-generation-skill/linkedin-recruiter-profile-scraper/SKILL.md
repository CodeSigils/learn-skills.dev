---
name: linkedin-recruiter-profile-scraper
description: "Collect profile details from LinkedIn Recruiter search — name, title, experience, skills, contact signals. Use when the user wants to build a candidate pipeline from LinkedIn Recruiter."
license: MIT
metadata:
...
Use this Skill for linkedin recruiter profile scraper on LinkedIn.
...
- "Run linkedin recruiter profile scraper and export the results to a CSV."
- "Collect linkedin recruiter profile data from this URL and return a table."
- "Find visible contact details using linkedin recruiter profile scraper for this list of targets."
- "Research these targets with linkedin recruiter profile scraper and return name, contact, source URL, and any visible signals."
