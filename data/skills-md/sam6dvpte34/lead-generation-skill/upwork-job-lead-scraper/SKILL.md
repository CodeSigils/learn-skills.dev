---
name: upwork-job-lead-scraper
description: "Collect job leads from Upwork — client name, job title, budget, required skills, posting date, client history. Use when the user wants to find freelance opportunities or prospect clients on Upwork."
license: MIT
metadata:
...
Use this Skill for upwork job lead scraper.
...
- "Run upwork job lead scraper and export the results to a CSV."
- "Collect upwork job lead data from this URL and return a table."
- "Find visible contact details using upwork job lead scraper for this list of targets."
- "Research these targets with upwork job lead scraper and return name, contact, source URL, and any visible signals."
