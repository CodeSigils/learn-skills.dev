---
name: marketing-agency-lead-scraper
description: "Collect marketing agency leads from Google Maps or directories — agency name, address, phone, website, services. Use when the user wants to prospect marketing agencies for B2B sales."
license: MIT
metadata:
...
Use this Skill for marketing agency lead scraper.
...
- "Run marketing agency lead scraper and export the results to a CSV."
- "Collect marketing agency lead data from this URL and return a table."
- "Find visible contact details using marketing agency lead scraper for this list of targets."
- "Research these targets with marketing agency lead scraper and return name, contact, source URL, and any visible signals."
