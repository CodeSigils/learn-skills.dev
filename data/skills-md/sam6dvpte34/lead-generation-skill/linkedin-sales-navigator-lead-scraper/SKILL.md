...
description: "Collect lead details from LinkedIn Sales Navigator — name, title, company, location, contact signals. Use when the user wants to export or enrich prospects from a Sales Navigator lead list."
license: MIT
metadata:
...
Use this Skill for linkedin sales navigator lead scraper on LinkedIn.
...
- "Run linkedin sales navigator lead scraper and export the results to a CSV."
- "Collect linkedin sales navigator lead data from this URL and return a table."
- "Find visible contact details using linkedin sales navigator lead scraper for this list of targets."
- "Research these targets with linkedin sales navigator lead scraper and return name, contact, source URL, and any visible signals."
