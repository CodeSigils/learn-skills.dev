---
name: tiktok-video-lead-scraper
description: "Collect leads from TikTok videos — video author, description, engagement, contact signals, account bio. Use when the user wants to identify prospects from relevant TikTok content."
license: MIT
metadata:
...
Use this Skill for tiktok video lead scraper.
...
- "Run tiktok video lead scraper and export the results to a CSV."
- "Collect tiktok video lead data from this URL and return a table."
- "Find visible contact details using tiktok video lead scraper for this list of targets."
- "Research these targets with tiktok video lead scraper and return name, contact, source URL, and any visible signals."
