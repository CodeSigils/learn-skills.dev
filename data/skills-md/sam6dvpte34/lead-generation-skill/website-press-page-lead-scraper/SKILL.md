---
name: website-press-page-lead-scraper
description: "Collect press contact and media signals from website press pages — contact email, press kit URL, company name, PR agency. Use when the user wants to find press or media contacts."
license: MIT
metadata:
...
Use this Skill for website press page lead scraper from company websites.
...
- "Run website press page lead scraper and export the results to a CSV."
- "Collect website press page lead data from this URL and return a table."
- "Find visible contact details using website press page lead scraper for this list of targets."
- "Research these targets with website press page lead scraper and return name, contact, source URL, and any visible signals."
