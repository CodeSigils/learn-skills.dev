---
name: linkedin-jobs-feed-scraper
description: "Collect job feed data from LinkedIn — company, job title, location, date posted, job URL. Use when the user wants to monitor new job postings from a set of target companies."
license: MIT
metadata:
...
Use this Skill for linkedin jobs feed scraper on LinkedIn.
...
- "Run linkedin jobs feed scraper and export the results to a CSV."
- "Collect linkedin jobs feed data from this URL and return a table."
- "Find visible contact details using linkedin jobs feed scraper for this list of targets."
- "Research these targets with linkedin jobs feed scraper and return name, contact, source URL, and any visible signals."
