---
name: website-careers-page-lead-scraper
description: "Collect hiring signals from website careers pages — company name, open roles, department, location, contact. Use when the user wants to identify hiring companies from their own careers pages."
license: MIT
metadata:
...
Use this Skill for website careers page lead scraper from company websites.
...
- "Run website careers page lead scraper and export the results to a CSV."
- "Collect website careers page lead data from this URL and return a table."
- "Find visible contact details using website careers page lead scraper for this list of targets."
- "Research these targets with website careers page lead scraper and return name, contact, source URL, and any visible signals."
