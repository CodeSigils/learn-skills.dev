---
name: mortgage-broker-lead-scraper
description: "Collect mortgage broker leads from Google Maps or directories — broker name, company, address, phone, website. Use when the user wants to prospect mortgage brokers or lenders."
license: MIT
metadata:
...
Use this Skill for mortgage broker lead scraper.
...
- "Run mortgage broker lead scraper and export the results to a CSV."
- "Collect mortgage broker lead data from this URL and return a table."
- "Find visible contact details using mortgage broker lead scraper for this list of targets."
- "Research these targets with mortgage broker lead scraper and return name, contact, source URL, and any visible signals."
