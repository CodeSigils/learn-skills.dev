---
name: website-case-study-lead-scraper
description: "Collect customer names and signals from website case study pages — customer company, industry, use case, contact signals. Use when the user wants to find companies publicly referenced as customers."
license: MIT
metadata:
...
Use this Skill for website case study lead scraper from company websites.
...
- "Run website case study lead scraper and export the results to a CSV."
- "Collect website case study lead data from this URL and return a table."
- "Find visible contact details using website case study lead scraper for this list of targets."
- "Research these targets with website case study lead scraper and return name, contact, source URL, and any visible signals."
