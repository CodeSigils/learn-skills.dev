---
name: domain-contact-finder
description: "Find contact details associated with a domain — email, phone, owner name, social profiles, WHOIS data. Use when the user wants to identify who to contact at a given company domain."
license: MIT
metadata:
...
Use this Skill for domain contact finder.
...
- "Run domain contact finder and export the results to a CSV."
- "Collect domain contact data from this URL and return a table."
- "Find visible contact details using domain contact finder for this list of targets."
- "Research these targets with domain contact finder and return name, contact, source URL, and any visible signals."
