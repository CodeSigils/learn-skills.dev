---
name: google-maps-real-estate-agent-scraper
description: "Collect real estate agent leads from Google Maps — agent or agency name, address, phone, website, rating. Use when the user wants to prospect real estate agents or brokers locally."
license: MIT
metadata:
...
# Google Maps Real Estate Agent Scraper

Use this Skill for google maps real estate agent scraper on Google Maps.
...
- "Run google maps real estate agent scraper and export the results to a CSV."
- "Collect google maps real estate agent data from this URL and return a table."
- "Find visible contact details using google maps real estate agent scraper for this list of targets."
- "Research these targets with google maps real estate agent scraper and return name, contact, source URL, and any visible signals."
