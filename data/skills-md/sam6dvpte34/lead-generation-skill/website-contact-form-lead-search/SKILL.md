---
name: website-contact-form-lead-search
description: "Find contact forms on websites — form URL, fields, email hints, company name. Use when the user wants to locate contact submission forms for outreach."
license: MIT
metadata:
...
Use this Skill for website contact form lead search from company websites.
...
- "Run website contact form lead search and export the results to a CSV."
- "Collect website contact form lead data from this URL and return a table."
- "Find visible contact details using website contact form lead search for this list of targets."
- "Research these targets with website contact form lead search and return name, contact, source URL, and any visible signals."
