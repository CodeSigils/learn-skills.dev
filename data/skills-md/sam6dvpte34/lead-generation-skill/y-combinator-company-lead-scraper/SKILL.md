---
name: y-combinator-company-lead-scraper
description: "Collect company leads from Y Combinator — company name, batch year, industry, website, founders, description. Use when the user wants to prospect YC-backed startups."
license: MIT
metadata:
...
Use this Skill for y combinator company lead scraper.
...
- "Run y combinator company lead scraper and export the results to a CSV."
- "Collect y combinator company lead data from this URL and return a table."
- "Find visible contact details using y combinator company lead scraper for this list of targets."
- "Research these targets with y combinator company lead scraper and return name, contact, source URL, and any visible signals."
