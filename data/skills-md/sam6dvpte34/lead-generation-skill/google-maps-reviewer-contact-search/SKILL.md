---
name: google-maps-reviewer-contact-search
description: "Find contact signals from Google Maps reviewers — reviewer name, profile link, review text, rating. Use when the user wants to identify and reach frequent reviewers or customers."
license: MIT
metadata:
...
# Google Maps Reviewer Contact Search

Use this Skill for google maps reviewer contact search on Google Maps.
...
- "Run google maps reviewer contact search and export the results to a CSV."
- "Collect google maps reviewer contact data from this URL and return a table."
- "Find visible contact details using google maps reviewer contact search for this list of targets."
- "Research these targets with google maps reviewer contact search and return name, contact, source URL, and any visible signals."
