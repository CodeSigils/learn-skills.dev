---
name: facebook-group-admin-contact-search
description: "Collect admin contact details from Facebook groups — admin name, profile link, bio, contact signals. Use when the user wants to reach group administrators for partnership or outreach."
license: MIT
metadata:
...
Use this Skill for facebook group admin contact search.
...
- "Run facebook group admin contact search and export the results to a CSV."
- "Collect facebook group admin contact data from this URL and return a table."
- "Find visible contact details using facebook group admin contact search for this list of targets."
- "Research these targets with facebook group admin contact search and return name, contact, source URL, and any visible signals."
