---
name: facebook-search-results-lead-scraper
description: "Collect leads from Facebook search results — profiles, pages, groups, contact signals, category. Use when the user wants to prospect across Facebook for a keyword or topic."
license: MIT
metadata:
...
Use this Skill for facebook search results lead scraper.
...
- "Run facebook search results lead scraper and export the results to a CSV."
- "Collect facebook results lead data from this URL and return a table."
- "Find visible contact details using facebook search results lead scraper for this list of targets."
- "Research these targets with facebook search results lead scraper and return name, contact, source URL, and any visible signals."
