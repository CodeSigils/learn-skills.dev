---
name: domain-email-enricher
description: "Enrich a domain list with email addresses — found emails, format patterns, contact names, source page. Use when the user wants to find email addresses for a list of company domains."
license: MIT
metadata:
...
Use this Skill for domain email enricher.
...
- "Run domain email enricher and export the results to a CSV."
- "Collect domain email enricher data from this URL and return a table."
- "Find visible contact details using domain email enricher for this list of targets."
- "Research these targets with domain email enricher and return name, contact, source URL, and any visible signals."
