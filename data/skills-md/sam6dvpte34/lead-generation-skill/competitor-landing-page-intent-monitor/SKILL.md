---
name: competitor-landing-page-intent-monitor
description: "Monitor competitor landing pages for intent signals — offer changes, CTA updates, pricing mentions, contact forms. Use when the user wants to track what competitors are actively promoting."
license: MIT
metadata:
...
Use this Skill for competitor landing page intent monitor.
...
- "Run competitor landing page intent monitor and export the results to a CSV."
- "Collect competitor landing page intent data from this URL and return a table."
- "Find visible contact details using competitor landing page intent monitor for this list of targets."
- "Research these targets with competitor landing page intent monitor and return name, contact, source URL, and any visible signals."
