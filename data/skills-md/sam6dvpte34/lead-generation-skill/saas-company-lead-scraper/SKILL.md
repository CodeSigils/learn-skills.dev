---
name: saas-company-lead-scraper
description: "Collect SaaS company leads from directories or search — company name, product, website, funding, team size, contact. Use when the user wants to prospect SaaS companies for partnerships or sales."
license: MIT
metadata:
...
Use this Skill for saas company lead scraper.
...
- "Run saas company lead scraper and export the results to a CSV."
- "Collect saas company lead data from this URL and return a table."
- "Find visible contact details using saas company lead scraper for this list of targets."
- "Research these targets with saas company lead scraper and return name, contact, source URL, and any visible signals."
