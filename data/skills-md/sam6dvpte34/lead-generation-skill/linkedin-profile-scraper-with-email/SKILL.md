---
name: linkedin-profile-scraper-with-email
description: "Collect LinkedIn profile data with email enrichment — name, title, company, email, phone, location. Use when the user wants verified contact details alongside LinkedIn profile information."
license: MIT
metadata:
...
Use this Skill for linkedin profile scraper with email on LinkedIn.
...
- "Run linkedin profile scraper with email and export the results to a CSV."
- "Collect linkedin profile with email data from this URL and return a table."
- "Find visible contact details using linkedin profile scraper with email for this list of targets."
- "Research these targets with linkedin profile scraper with email and return name, contact, source URL, and any visible signals."
