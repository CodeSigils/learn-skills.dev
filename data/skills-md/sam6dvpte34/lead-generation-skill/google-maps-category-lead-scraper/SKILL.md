---
name: google-maps-category-lead-scraper
description: "Collect category-specific leads from Google Maps — business name, category, address, phone, website, rating. Use when the user wants to scrape all businesses in a specific category and area."
license: MIT
metadata:
...
Use this Skill for google maps category lead scraper on Google Maps.
...
- "Run google maps category lead scraper and export the results to a CSV."
- "Collect google maps category lead data from this URL and return a table."
- "Find visible contact details using google maps category lead scraper for this list of targets."
- "Research these targets with google maps category lead scraper and return name, contact, source URL, and any visible signals."
