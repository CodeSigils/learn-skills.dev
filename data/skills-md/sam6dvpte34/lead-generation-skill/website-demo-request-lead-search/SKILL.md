---
name: website-demo-request-lead-search
description: "Find demo request forms or CTAs on websites — company name, demo CTA URL, form fields, contact signals. Use when the user wants to identify companies offering demos as a buying signal."
license: MIT
metadata:
...
Use this Skill for website demo request lead search from company websites.
...
- "Run website demo request lead search and export the results to a CSV."
- "Collect website demo request lead data from this URL and return a table."
- "Find visible contact details using website demo request lead search for this list of targets."
- "Research these targets with website demo request lead search and return name, contact, source URL, and any visible signals."
