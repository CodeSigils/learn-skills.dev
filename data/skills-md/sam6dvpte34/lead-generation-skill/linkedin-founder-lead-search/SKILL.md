---
name: linkedin-founder-lead-search
description: "Search for founder leads on LinkedIn — founder name, company, industry, location, profile URL. Use when the user wants to prospect startup founders or company founders."
license: MIT
metadata:
...
Use this Skill for linkedin founder lead search on LinkedIn.
...
- "Run linkedin founder lead search and export the results to a CSV."
- "Collect linkedin founder lead data from this URL and return a table."
- "Find visible contact details using linkedin founder lead search for this list of targets."
- "Research these targets with linkedin founder lead search and return name, contact, source URL, and any visible signals."
