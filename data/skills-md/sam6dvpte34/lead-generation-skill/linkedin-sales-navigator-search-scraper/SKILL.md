---
name: linkedin-sales-navigator-search-scraper
description: "Collect search results from LinkedIn Sales Navigator — name, title, company, location, profile URL. Use when the user wants to build a targeted prospect list using Sales Navigator."
license: MIT
metadata:
...
Use this Skill for linkedin sales navigator search scraper on LinkedIn.
...
- "Run linkedin sales navigator search scraper and export the results to a CSV."
- "Collect linkedin sales navigator data from this URL and return a table."
- "Find visible contact details using linkedin sales navigator search scraper for this list of targets."
- "Research these targets with linkedin sales navigator search scraper and return name, contact, source URL, and any visible signals."
