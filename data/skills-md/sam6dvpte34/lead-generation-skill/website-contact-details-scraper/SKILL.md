...
description: "Collect contact details from website contact pages — email, phone, address, contact form URL, social profiles. Use when the user wants to extract contact information from a company's website."
license: MIT
metadata:
...
Use this Skill for website contact details scraper from company websites.
...
- "Run website contact details scraper and export the results to a CSV."
- "Collect website contact details data from this URL and return a table."
- "Find visible contact details using website contact details scraper for this list of targets."
- "Research these targets with website contact details scraper and return name, contact, source URL, and any visible signals."
