---
name: indeed-job-lead-scraper
description: "Collect job and company leads from Indeed — company name, job title, location, posting date, company website. Use when the user wants to find hiring companies or recruit candidates."
license: MIT
metadata:
...
Use this Skill for indeed job lead scraper.
...
- "Run indeed job lead scraper and export the results to a CSV."
- "Collect indeed job lead data from this URL and return a table."
- "Find visible contact details using indeed job lead scraper for this list of targets."
- "Research these targets with indeed job lead scraper and return name, contact, source URL, and any visible signals."
