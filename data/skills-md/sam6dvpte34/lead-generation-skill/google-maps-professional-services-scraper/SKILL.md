---
name: google-maps-professional-services-scraper
description: "Collect professional services leads from Google Maps — firm name, specialty, address, phone, website, rating. Use when the user wants to prospect lawyers, accountants, consultants, or other professionals."
license: MIT
metadata:
...
Use this Skill for google maps professional services scraper on Google Maps.
...
- "Run google maps professional services scraper and export the results to a CSV."
- "Collect google maps professional services data from this URL and return a table."
- "Find visible contact details using google maps professional services scraper for this list of targets."
- "Research these targets with google maps professional services scraper and return name, contact, source URL, and any visible signals."
