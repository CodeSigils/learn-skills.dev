---
name: crunchbase-company-lead-scraper
description: "Collect company leads from Crunchbase — company name, industry, funding stage, location, website, founders. Use when the user wants to prospect funded or high-growth companies."
license: MIT
metadata:
...
# Crunchbase Company Lead Scraper

Use this Skill for crunchbase company lead scraper on Crunchbase.
...
- "Run crunchbase company lead scraper and export the results to a CSV."
- "Collect crunchbase company lead data from this URL and return a table."
- "Find visible contact details using crunchbase company lead scraper for this list of targets."
- "Research these targets with crunchbase company lead scraper and return name, contact, source URL, and any visible signals."
