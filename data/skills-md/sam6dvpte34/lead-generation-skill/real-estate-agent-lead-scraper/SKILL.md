---
name: real-estate-agent-lead-scraper
description: "Collect real estate agent leads from directories or Google Maps — agent name, agency, phone, email, website. Use when the user wants to prospect real estate agents for B2B services."
license: MIT
metadata:
...
Use this Skill for real estate agent lead scraper.
...
- "Run real estate agent lead scraper and export the results to a CSV."
- "Collect real estate agent lead data from this URL and return a table."
- "Find visible contact details using real estate agent lead scraper for this list of targets."
- "Research these targets with real estate agent lead scraper and return name, contact, source URL, and any visible signals."
