---
name: google-maps-chain-store-lead-search
description: "Search for chain store leads on Google Maps — brand name, location, address, phone, website. Use when the user wants to identify and contact all stores of a particular chain."
license: MIT
metadata:
...
Use this Skill for google maps chain store lead search on Google Maps.
...
- "Run google maps chain store lead search and export the results to a CSV."
- "Collect google maps chain store lead data from this URL and return a table."
- "Find visible contact details using google maps chain store lead search for this list of targets."
- "Research these targets with google maps chain store lead search and return name, contact, source URL, and any visible signals."
