---
name: domain-phone-enricher
description: "Enrich a domain list with phone numbers — found phone numbers, location, contact name, source page. Use when the user wants to find phone numbers for a list of company domains."
license: MIT
metadata:
...
Use this Skill for domain phone enricher.
...
- "Run domain phone enricher and export the results to a CSV."
- "Collect domain phone enricher data from this URL and return a table."
- "Find visible contact details using domain phone enricher for this list of targets."
- "Research these targets with domain phone enricher and return name, contact, source URL, and any visible signals."
