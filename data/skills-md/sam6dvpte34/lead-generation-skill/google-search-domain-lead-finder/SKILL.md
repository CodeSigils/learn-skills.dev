---
name: google-search-domain-lead-finder
description: "Find domain leads from Google Search — domain, company name, description, contact signals. Use when the user wants to discover company websites matching a search query."
license: MIT
metadata:
...
Use this Skill for google search domain lead finder on Google Search.
...
- "Run google search domain lead finder and export the results to a CSV."
- "Collect google domain lead data from this URL and return a table."
- "Find visible contact details using google search domain lead finder for this list of targets."
- "Research these targets with google search domain lead finder and return name, contact, source URL, and any visible signals."
