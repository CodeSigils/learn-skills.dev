---
name: saas-marketplace-lead-scraper
description: "Collect SaaS listing leads from marketplaces like G2 or Capterra — company name, category, website, contact signals. Use when the user wants to prospect software vendors from marketplace listings."
license: MIT
metadata:
...
Use this Skill for saas marketplace lead scraper.
...
- "Run saas marketplace lead scraper and export the results to a CSV."
- "Collect saas marketplace lead data from this URL and return a table."
- "Find visible contact details using saas marketplace lead scraper for this list of targets."
- "Research these targets with saas marketplace lead scraper and return name, contact, source URL, and any visible signals."
