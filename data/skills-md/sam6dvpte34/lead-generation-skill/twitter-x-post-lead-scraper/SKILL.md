---
name: twitter-x-post-lead-scraper
description: "Collect leads from Twitter/X posts — post author, post text, engagement, account bio, contact signals. Use when the user wants to identify prospects engaging with relevant content."
license: MIT
metadata:
...
Use this Skill for twitter/x post lead scraper.
...
- "Run twitter/x post lead scraper and export the results to a CSV."
- "Collect twitter/x post lead data from this URL and return a table."
- "Find visible contact details using twitter/x post lead scraper for this list of targets."
- "Research these targets with twitter/x post lead scraper and return name, contact, source URL, and any visible signals."
