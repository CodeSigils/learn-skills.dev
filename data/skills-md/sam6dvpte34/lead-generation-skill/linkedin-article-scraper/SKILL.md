---
name: linkedin-article-scraper
description: "Collect articles published on LinkedIn — title, author, date, content summary, engagement. Use when the user wants to research thought leadership or find prospects publishing content."
license: MIT
metadata:
...
Use this Skill for linkedin article scraper on LinkedIn.
...
- "Run linkedin article scraper and export the results to a CSV."
- "Collect linkedin article data from this URL and return a table."
- "Find visible contact details using linkedin article scraper for this list of targets."
- "Research these targets with linkedin article scraper and return name, contact, source URL, and any visible signals."
