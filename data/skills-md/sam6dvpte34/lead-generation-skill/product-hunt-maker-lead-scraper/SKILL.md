---
name: product-hunt-maker-lead-scraper
description: "Collect maker leads from Product Hunt — maker name, products, profile URL, website, contact signals. Use when the user wants to prospect active makers in the Product Hunt community."
license: MIT
metadata:
...
Use this Skill for product hunt maker lead scraper.
...
- "Run product hunt maker lead scraper and export the results to a CSV."
- "Collect product hunt maker lead data from this URL and return a table."
- "Find visible contact details using product hunt maker lead scraper for this list of targets."
- "Research these targets with product hunt maker lead scraper and return name, contact, source URL, and any visible signals."
