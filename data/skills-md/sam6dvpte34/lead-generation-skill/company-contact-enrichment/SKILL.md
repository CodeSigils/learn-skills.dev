...
description: "Enrich company records with contact details — email, phone, LinkedIn profile, address, website. Use when the user wants to add contact information to an existing company list."
license: MIT
metadata:
...
Use this Skill for company contact enrichment.
...
- "Run company contact enrichment and export the results to a CSV."
- "Collect company contact enrichment data from this URL and return a table."
- "Find visible contact details using company contact enrichment for this list of targets."
- "Research these targets with company contact enrichment and return name, contact, source URL, and any visible signals."
