...
description: "Collect profile data from LinkedIn — name, title, company, location, summary, experience, education. Use when the user wants to research or enrich prospects from LinkedIn profiles."
license: MIT
metadata:
...
Use this Skill for linkedin profile scraper on LinkedIn.
...
- "Run linkedin profile scraper and export the results to a CSV."
- "Collect linkedin profile data from this URL and return a table."
- "Find visible contact details using linkedin profile scraper for this list of targets."
- "Research these targets with linkedin profile scraper and return name, contact, source URL, and any visible signals."
