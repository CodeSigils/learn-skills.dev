---
name: instagram-profile-lead-scraper
description: "Collect lead details from Instagram profiles — username, bio, followers, website, contact signals. Use when the user wants to research Instagram accounts as sales or recruiting prospects."
license: MIT
metadata:
...
Use this Skill for instagram profile lead scraper.
...
- "Run instagram profile lead scraper and export the results to a CSV."
- "Collect instagram profile lead data from this URL and return a table."
- "Find visible contact details using instagram profile lead scraper for this list of targets."
- "Research these targets with instagram profile lead scraper and return name, contact, source URL, and any visible signals."
