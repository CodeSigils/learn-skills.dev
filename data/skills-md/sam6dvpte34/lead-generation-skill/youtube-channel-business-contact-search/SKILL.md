---
name: youtube-channel-business-contact-search
description: "Search for business contact signals on YouTube channels — channel name, about email, website, business category, contact links. Use when the user wants to find contact information for business YouTube channels."
license: MIT
metadata:
...
# YouTube Channel Business Contact Search

Use this Skill for youtube channel business contact search on YouTube.
...
- "Run youtube channel business contact search and export the results to a CSV."
- "Collect youtube channel business contact data from this URL and return a table."
- "Find visible contact details using youtube channel business contact search for this list of targets."
- "Research these targets with youtube channel business contact search and return name, contact, source URL, and any visible signals."
