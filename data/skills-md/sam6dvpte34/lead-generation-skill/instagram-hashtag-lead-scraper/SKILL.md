---
name: instagram-hashtag-lead-scraper
description: "Collect leads from Instagram hashtags — post author, bio, website, contact signals, hashtag context. Use when the user wants to prospect accounts posting under a target hashtag."
license: MIT
metadata:
...
Use this Skill for instagram hashtag lead scraper.
...
- "Run instagram hashtag lead scraper and export the results to a CSV."
- "Collect instagram hashtag lead data from this URL and return a table."
- "Find visible contact details using instagram hashtag lead scraper for this list of targets."
- "Research these targets with instagram hashtag lead scraper and return name, contact, source URL, and any visible signals."
