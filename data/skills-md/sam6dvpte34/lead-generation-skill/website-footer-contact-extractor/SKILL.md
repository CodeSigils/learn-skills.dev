---
name: website-footer-contact-extractor
description: "Extract contact details from website footers — email, phone, address, social links, legal entity. Use when the user wants to find contact information embedded in website footers."
license: MIT
metadata:
...
Use this Skill for website footer contact extractor from company websites.
...
- "Run website footer contact extractor and export the results to a CSV."
- "Collect website footer contact extractor data from this URL and return a table."
- "Find visible contact details using website footer contact extractor for this list of targets."
- "Research these targets with website footer contact extractor and return name, contact, source URL, and any visible signals."
