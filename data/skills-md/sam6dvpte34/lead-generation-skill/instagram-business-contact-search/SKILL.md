---
name: instagram-business-contact-search
description: "Search for business contact signals on Instagram — username, bio email, website, category, phone. Use when the user wants to find contact information for business accounts on Instagram."
license: MIT
metadata:
...
Use this Skill for instagram business contact search.
...
- "Run instagram business contact search and export the results to a CSV."
- "Collect instagram business contact data from this URL and return a table."
- "Find visible contact details using instagram business contact search for this list of targets."
- "Research these targets with instagram business contact search and return name, contact, source URL, and any visible signals."
