---
name: instagram-following-lead-scraper
description: "Collect following leads from Instagram profiles — following username, bio, website, contact signals. Use when the user wants to research who a target account follows."
license: MIT
metadata:
...
Use this Skill for instagram following lead scraper.
...
- "Run instagram following lead scraper and export the results to a CSV."
- "Collect instagram following lead data from this URL and return a table."
- "Find visible contact details using instagram following lead scraper for this list of targets."
- "Research these targets with instagram following lead scraper and return name, contact, source URL, and any visible signals."
