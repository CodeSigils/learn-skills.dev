---
name: website-event-page-lead-scraper
description: "Collect event and speaker leads from website event pages — event name, date, speakers, company, contact signals. Use when the user wants to prospect from company-hosted events."
license: MIT
metadata:
...
Use this Skill for website event page lead scraper from company websites.
...
- "Run website event page lead scraper and export the results to a CSV."
- "Collect website event page lead data from this URL and return a table."
- "Find visible contact details using website event page lead scraper for this list of targets."
- "Research these targets with website event page lead scraper and return name, contact, source URL, and any visible signals."
