---
name: lawyer-law-firm-lead-scraper
description: "Collect lawyer and law firm leads from Google Maps or directories — firm name, specialty, address, phone, website. Use when the user wants to prospect law firms or attorneys for B2B services."
license: MIT
metadata:
...
Use this Skill for lawyer law firm lead scraper.
...
- "Run lawyer law firm lead scraper and export the results to a CSV."
- "Collect lawyer law firm lead data from this URL and return a table."
- "Find visible contact details using lawyer law firm lead scraper for this list of targets."
- "Research these targets with lawyer law firm lead scraper and return name, contact, source URL, and any visible signals."
