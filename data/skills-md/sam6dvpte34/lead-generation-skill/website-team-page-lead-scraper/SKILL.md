---
name: website-team-page-lead-scraper
description: "Collect team member leads from website team pages — name, title, department, LinkedIn URL, contact signals. Use when the user wants to map team structures or find decision makers."
license: MIT
metadata:
...
Use this Skill for website team page lead scraper from company websites.
...
- "Run website team page lead scraper and export the results to a CSV."
- "Collect website team page lead data from this URL and return a table."
- "Find visible contact details using website team page lead scraper for this list of targets."
- "Research these targets with website team page lead scraper and return name, contact, source URL, and any visible signals."
