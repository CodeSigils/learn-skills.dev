---
name: public-directory-contact-scraper
description: "Collect contact details from public directories — name, title, company, address, phone, email. Use when the user wants to extract contacts from a business or professional directory."
license: MIT
metadata:
...
Use this Skill for public directory contact scraper.
...
- "Run public directory contact scraper and export the results to a CSV."
- "Collect public directory contact data from this URL and return a table."
- "Find visible contact details using public directory contact scraper for this list of targets."
- "Research these targets with public directory contact scraper and return name, contact, source URL, and any visible signals."
