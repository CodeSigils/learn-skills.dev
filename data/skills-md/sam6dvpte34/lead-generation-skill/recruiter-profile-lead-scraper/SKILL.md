---
name: recruiter-profile-lead-scraper
description: "Collect recruiter profile leads from LinkedIn or directories — recruiter name, company, industry, contact signals. Use when the user wants to find recruiters for partnerships or job placement."
license: MIT
metadata:
...
Use this Skill for recruiter profile lead scraper.
...
- "Run recruiter profile lead scraper and export the results to a CSV."
- "Collect recruiter profile lead data from this URL and return a table."
- "Find visible contact details using recruiter profile lead scraper for this list of targets."
- "Research these targets with recruiter profile lead scraper and return name, contact, source URL, and any visible signals."
