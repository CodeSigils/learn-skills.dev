...
description: "Extract phone numbers from any webpage — phone number, format, associated name or company, source URL. Use when the user wants to collect visible phone contacts from a page or site."
license: MIT
metadata:
...
Use this Skill for phone number extractor.
...
- "Run phone number extractor and export the results to a CSV."
- "Collect phone number extractor data from this URL and return a table."
- "Find visible contact details using phone number extractor for this list of targets."
- "Research these targets with phone number extractor and return name, contact, source URL, and any visible signals."
