---
name: linkedin-sales-navigator-company-scraper
description: "Collect company data from LinkedIn Sales Navigator — company name, industry, size, revenue, location, profile URL. Use when the user wants to prospect companies using Sales Navigator filters."
license: MIT
metadata:
...
Use this Skill for linkedin sales navigator company scraper on LinkedIn.
...
- "Run linkedin sales navigator company scraper and export the results to a CSV."
- "Collect linkedin sales navigator company data from this URL and return a table."
- "Find visible contact details using linkedin sales navigator company scraper for this list of targets."
- "Research these targets with linkedin sales navigator company scraper and return name, contact, source URL, and any visible signals."
