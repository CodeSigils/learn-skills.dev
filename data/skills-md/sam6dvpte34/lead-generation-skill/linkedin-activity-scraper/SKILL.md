---
name: linkedin-activity-scraper
description: "Collect activity data from LinkedIn profiles — recent posts, likes, comments, shares, topics. Use when the user wants to research prospect engagement and interests on LinkedIn."
license: MIT
metadata:
...
Use this Skill for linkedin activity scraper on LinkedIn.
...
- "Run linkedin activity scraper and export the results to a CSV."
- "Collect linkedin activity data from this URL and return a table."
- "Find visible contact details using linkedin activity scraper for this list of targets."
- "Research these targets with linkedin activity scraper and return name, contact, source URL, and any visible signals."
