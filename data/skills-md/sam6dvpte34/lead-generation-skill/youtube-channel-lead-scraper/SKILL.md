---
name: youtube-channel-lead-scraper
description: "Collect lead details from YouTube channels — channel name, subscriber count, contact email, website, category. Use when the user wants to build a prospect list from YouTube channels."
license: MIT
metadata:
...
Use this Skill for youtube channel lead scraper on YouTube.
...
- "Run youtube channel lead scraper and export the results to a CSV."
- "Collect youtube channel lead data from this URL and return a table."
- "Find visible contact details using youtube channel lead scraper for this list of targets."
- "Research these targets with youtube channel lead scraper and return name, contact, source URL, and any visible signals."
