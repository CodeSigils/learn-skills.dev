---
name: linkedin-recruiter-lead-search
description: "Search for candidate leads in LinkedIn Recruiter — name, title, location, skills, contact signals. Use when the user wants to find qualified candidates for a role."
license: MIT
metadata:
...
Use this Skill for linkedin recruiter lead search on LinkedIn.
...
- "Run linkedin recruiter lead search and export the results to a CSV."
- "Collect linkedin recruiter lead data from this URL and return a table."
- "Find visible contact details using linkedin recruiter lead search for this list of targets."
- "Research these targets with linkedin recruiter lead search and return name, contact, source URL, and any visible signals."
