---
name: linkedin-title-search-scraper
description: "Search for leads by job title on LinkedIn — name, title, company, location, profile URL. Use when the user wants to find all people with a specific job title."
license: MIT
metadata:
...
Use this Skill for linkedin title search scraper on LinkedIn.
...
- "Run linkedin title search scraper and export the results to a CSV."
- "Collect linkedin title data from this URL and return a table."
- "Find visible contact details using linkedin title search scraper for this list of targets."
- "Research these targets with linkedin title search scraper and return name, contact, source URL, and any visible signals."
