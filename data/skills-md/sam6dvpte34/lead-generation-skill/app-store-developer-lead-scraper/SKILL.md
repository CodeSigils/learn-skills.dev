---
name: app-store-developer-lead-scraper
description: "Collect app developer leads from the App Store or Google Play — developer name, contact email, app category, website. Use when the user wants to prospect mobile app developers."
license: MIT
metadata:
...
Use this Skill for app store developer lead scraper.
...
- "Run app store developer lead scraper and export the results to a CSV."
- "Collect app store developer lead data from this URL and return a table."
- "Find visible contact details using app store developer lead scraper for this list of targets."
- "Research these targets with app store developer lead scraper and return name, contact, source URL, and any visible signals."
