...
description: "Extract email addresses from any webpage — email, associated name, context, source URL. Use when the user wants to collect all visible email addresses from a page or set of pages."
license: MIT
metadata:
...
Use this Skill for email address extractor.
...
- "Run email address extractor and export the results to a CSV."
- "Collect email address extractor data from this URL and return a table."
- "Find visible contact details using email address extractor for this list of targets."
- "Research these targets with email address extractor and return name, contact, source URL, and any visible signals."
