---
name: linkedin-network-connection-scraper
description: "Collect connection data from LinkedIn network — connection name, title, company, profile URL. Use when the user wants to export or analyze their own LinkedIn connections."
license: MIT
metadata:
...
Use this Skill for linkedin network connection scraper on LinkedIn.
...
- "Run linkedin network connection scraper and export the results to a CSV."
- "Collect linkedin network connection data from this URL and return a table."
- "Find visible contact details using linkedin network connection scraper for this list of targets."
- "Research these targets with linkedin network connection scraper and return name, contact, source URL, and any visible signals."
