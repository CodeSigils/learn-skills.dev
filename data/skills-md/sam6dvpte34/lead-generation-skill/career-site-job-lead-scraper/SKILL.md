---
name: career-site-job-lead-scraper
description: "Collect job and company leads from career site pages — company name, job title, department, location, contact signals. Use when the user wants to find hiring companies as sales prospects."
license: MIT
metadata:
...
Use this Skill for career site job lead scraper.
...
- "Run career site job lead scraper and export the results to a CSV."
- "Collect career site job lead data from this URL and return a table."
- "Find visible contact details using career site job lead scraper for this list of targets."
- "Research these targets with career site job lead scraper and return name, contact, source URL, and any visible signals."
