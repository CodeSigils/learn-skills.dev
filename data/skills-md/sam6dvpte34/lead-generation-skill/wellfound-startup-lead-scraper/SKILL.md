---
name: wellfound-startup-lead-scraper
description: "Collect startup leads from Wellfound — company name, industry, funding stage, team size, website, contact. Use when the user wants to prospect startups from Wellfound listings."
license: MIT
metadata:
...
Use this Skill for wellfound startup lead scraper.
...
- "Run wellfound startup lead scraper and export the results to a CSV."
- "Collect wellfound startup lead data from this URL and return a table."
- "Find visible contact details using wellfound startup lead scraper for this list of targets."
- "Research these targets with wellfound startup lead scraper and return name, contact, source URL, and any visible signals."
