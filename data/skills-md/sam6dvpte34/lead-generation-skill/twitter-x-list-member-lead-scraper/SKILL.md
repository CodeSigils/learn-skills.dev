---
name: twitter-x-list-member-lead-scraper
description: "Collect leads from Twitter/X lists — member username, display name, bio, website, contact signals. Use when the user wants to prospect curated list members on Twitter/X."
license: MIT
metadata:
...
Use this Skill for twitter/x list member lead scraper.
...
- "Run twitter/x list member lead scraper and export the results to a CSV."
- "Collect twitter/x list member lead data from this URL and return a table."
- "Find visible contact details using twitter/x list member lead scraper for this list of targets."
- "Research these targets with twitter/x list member lead scraper and return name, contact, source URL, and any visible signals."
