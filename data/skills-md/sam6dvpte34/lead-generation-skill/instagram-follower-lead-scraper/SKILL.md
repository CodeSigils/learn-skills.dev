---
name: instagram-follower-lead-scraper
description: "Collect follower leads from Instagram profiles — follower username, bio, website, contact signals. Use when the user wants to prospect followers of a target account."
license: MIT
metadata:
...
Use this Skill for instagram follower lead scraper.
...
- "Run instagram follower lead scraper and export the results to a CSV."
- "Collect instagram follower lead data from this URL and return a table."
- "Find visible contact details using instagram follower lead scraper for this list of targets."
- "Research these targets with instagram follower lead scraper and return name, contact, source URL, and any visible signals."
