---
name: hiring-company-lead-scraper
description: "Collect hiring company leads from job boards or search — company name, open roles, industry, website, contact signals. Use when the user wants to prospect companies that are actively hiring."
license: MIT
metadata:
...
Use this Skill for hiring company lead scraper.
...
- "Run hiring company lead scraper and export the results to a CSV."
- "Collect hiring company lead data from this URL and return a table."
- "Find visible contact details using hiring company lead scraper for this list of targets."
- "Research these targets with hiring company lead scraper and return name, contact, source URL, and any visible signals."
