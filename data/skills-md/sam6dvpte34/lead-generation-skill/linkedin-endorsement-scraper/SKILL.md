---
name: linkedin-endorsement-scraper
description: "Collect skill endorsements from LinkedIn profiles — skill name, endorsement count, endorsers. Use when the user wants to validate expertise or find professionals with specific skills."
license: MIT
metadata:
...
Use this Skill for linkedin endorsement scraper on LinkedIn.
...
- "Run linkedin endorsement scraper and export the results to a CSV."
- "Collect linkedin endorsement data from this URL and return a table."
- "Find visible contact details using linkedin endorsement scraper for this list of targets."
- "Research these targets with linkedin endorsement scraper and return name, contact, source URL, and any visible signals."
