---
name: facebook-ad-library-lead-scraper
description: "Collect advertiser leads from Facebook Ad Library — company name, ad creative, website, contact signals. Use when the user wants to prospect companies running Facebook ads."
license: MIT
metadata:
...
Use this Skill for facebook ad library lead scraper.
...
- "Run facebook ad library lead scraper and export the results to a CSV."
- "Collect facebook ad library lead data from this URL and return a table."
- "Find visible contact details using facebook ad library lead scraper for this list of targets."
- "Research these targets with facebook ad library lead scraper and return name, contact, source URL, and any visible signals."
