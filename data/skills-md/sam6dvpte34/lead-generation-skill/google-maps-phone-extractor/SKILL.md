---
name: google-maps-phone-extractor
description: "Extract phone numbers from Google Maps listings — business name, phone, address, category. Use when the user wants to collect phone contacts from local business listings."
license: MIT
metadata:
...
Use this Skill for google maps phone extractor on Google Maps.
...
- "Run google maps phone extractor and export the results to a CSV."
- "Collect google maps phone extractor data from this URL and return a table."
- "Find visible contact details using google maps phone extractor for this list of targets."
- "Research these targets with google maps phone extractor and return name, contact, source URL, and any visible signals."
