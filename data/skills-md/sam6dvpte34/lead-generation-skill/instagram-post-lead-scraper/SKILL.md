---
name: instagram-post-lead-scraper
description: "Collect leads from Instagram posts — post author, caption, engagement, bio link, contact signals. Use when the user wants to identify prospects from post content or engagement."
license: MIT
metadata:
...
Use this Skill for instagram post lead scraper.
...
- "Run instagram post lead scraper and export the results to a CSV."
- "Collect instagram post lead data from this URL and return a table."
- "Find visible contact details using instagram post lead scraper for this list of targets."
- "Research these targets with instagram post lead scraper and return name, contact, source URL, and any visible signals."
