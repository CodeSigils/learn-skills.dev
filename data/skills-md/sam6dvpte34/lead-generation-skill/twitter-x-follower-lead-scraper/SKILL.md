---
name: twitter-x-follower-lead-scraper
description: "Collect follower leads from Twitter/X profiles — follower username, display name, bio, website, contact signals. Use when the user wants to prospect followers of a target account."
license: MIT
metadata:
...
Use this Skill for twitter/x follower lead scraper.
...
- "Run twitter/x follower lead scraper and export the results to a CSV."
- "Collect twitter/x follower lead data from this URL and return a table."
- "Find visible contact details using twitter/x follower lead scraper for this list of targets."
- "Research these targets with twitter/x follower lead scraper and return name, contact, source URL, and any visible signals."
