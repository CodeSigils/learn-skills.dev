---
name: linkedin-following-scraper
description: "Collect following data from LinkedIn profiles — followed name, title, company, profile URL. Use when the user wants to research who a prospect follows on LinkedIn."
license: MIT
metadata:
...
Use this Skill for linkedin following scraper on LinkedIn.
...
- "Run linkedin following scraper and export the results to a CSV."
- "Collect linkedin following data from this URL and return a table."
- "Find visible contact details using linkedin following scraper for this list of targets."
- "Research these targets with linkedin following scraper and return name, contact, source URL, and any visible signals."
