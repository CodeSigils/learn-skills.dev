---
name: website-partners-page-lead-scraper
description: "Collect partner company leads from website partner pages — partner name, partner type, website, contact signals. Use when the user wants to map vendor or partner relationships."
license: MIT
metadata:
...
Use this Skill for website partners page lead scraper from company websites.
...
- "Run website partners page lead scraper and export the results to a CSV."
- "Collect website partners page lead data from this URL and return a table."
- "Find visible contact details using website partners page lead scraper for this list of targets."
- "Research these targets with website partners page lead scraper and return name, contact, source URL, and any visible signals."
