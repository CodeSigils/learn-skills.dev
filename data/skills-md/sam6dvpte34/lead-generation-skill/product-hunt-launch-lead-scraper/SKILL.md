---
name: product-hunt-launch-lead-scraper
description: "Collect launch leads from Product Hunt — product name, maker, launch date, upvotes, website, contact. Use when the user wants to prospect startups that recently launched on Product Hunt."
license: MIT
metadata:
...
Use this Skill for product hunt launch lead scraper.
...
- "Run product hunt launch lead scraper and export the results to a CSV."
- "Collect product hunt launch lead data from this URL and return a table."
- "Find visible contact details using product hunt launch lead scraper for this list of targets."
- "Research these targets with product hunt launch lead scraper and return name, contact, source URL, and any visible signals."
