---
name: facebook-post-lead-scraper
description: "Collect leads from Facebook posts — author, post text, engagement, contact signals, profile link. Use when the user wants to identify prospects engaging with relevant content."
license: MIT
metadata:
...
Use this Skill for facebook post lead scraper.
...
- "Run facebook post lead scraper and export the results to a CSV."
- "Collect facebook post lead data from this URL and return a table."
- "Find visible contact details using facebook post lead scraper for this list of targets."
- "Research these targets with facebook post lead scraper and return name, contact, source URL, and any visible signals."
