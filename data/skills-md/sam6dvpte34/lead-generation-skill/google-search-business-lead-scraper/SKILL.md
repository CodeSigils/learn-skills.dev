---
name: google-search-business-lead-scraper
description: "Collect business leads from Google Search results — business name, website, description, contact signals. Use when the user wants to find businesses matching a keyword or industry query."
license: MIT
metadata:
...
Use this Skill for google search business lead scraper on Google Search.
...
- "Run google search business lead scraper and export the results to a CSV."
- "Collect google business lead data from this URL and return a table."
- "Find visible contact details using google search business lead scraper for this list of targets."
- "Research these targets with google search business lead scraper and return name, contact, source URL, and any visible signals."
