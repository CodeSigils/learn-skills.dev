---
name: tiktok-creative-center-intent-scraper
description: "Collect ad intent signals from TikTok Creative Center — advertiser, ad creative, industry, trending signals. Use when the user wants to identify companies running TikTok ads as buyer intent signals."
license: MIT
metadata:
...
# TikTok Creative Center Intent Scraper

Use this Skill for tiktok creative center intent scraper.
...
- "Run tiktok creative center intent scraper and export the results to a CSV."
- "Collect tiktok creative center intent data from this URL and return a table."
- "Find visible contact details using tiktok creative center intent scraper for this list of targets."
- "Research these targets with tiktok creative center intent scraper and return name, contact, source URL, and any visible signals."
