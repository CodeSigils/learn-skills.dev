---
name: facebook-group-member-lead-scraper
description: "Collect member leads from Facebook groups — member name, profile link, bio, location, contact signals. Use when the user wants to build a prospect list from a niche Facebook group."
license: MIT
metadata:
...
Use this Skill for facebook group member lead scraper.
...
- "Run facebook group member lead scraper and export the results to a CSV."
- "Collect facebook group member lead data from this URL and return a table."
- "Find visible contact details using facebook group member lead scraper for this list of targets."
- "Research these targets with facebook group member lead scraper and return name, contact, source URL, and any visible signals."
