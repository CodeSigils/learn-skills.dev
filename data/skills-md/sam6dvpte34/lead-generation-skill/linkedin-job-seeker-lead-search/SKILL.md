---
name: linkedin-job-seeker-lead-search
description: "Search for job seekers on LinkedIn — name, current title, location, open-to-work status, profile URL. Use when the user wants to recruit candidates or prospect people in career transition."
license: MIT
metadata:
...
Use this Skill for linkedin job seeker lead search on LinkedIn.
...
- "Run linkedin job seeker lead search and export the results to a CSV."
- "Collect linkedin job seeker lead data from this URL and return a table."
- "Find visible contact details using linkedin job seeker lead search for this list of targets."
- "Research these targets with linkedin job seeker lead search and return name, contact, source URL, and any visible signals."
