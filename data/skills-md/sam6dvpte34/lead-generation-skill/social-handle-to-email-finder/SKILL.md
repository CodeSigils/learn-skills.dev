---
name: social-handle-to-email-finder
description: "Find email addresses associated with social handles — social username, platform, found email, source signals. Use when the user wants to convert social profiles into email contacts."
license: MIT
metadata:
...
Use this Skill for social handle to email finder.
...
- "Run social handle to email finder and export the results to a CSV."
- "Collect social handle to email data from this URL and return a table."
- "Find visible contact details using social handle to email finder for this list of targets."
- "Research these targets with social handle to email finder and return name, contact, source URL, and any visible signals."
