...
description: "Extract email addresses from Google Maps listings — business name, email, phone, website, address. Use when the user wants to collect email contacts from local business listings."
license: MIT
metadata:
...
Use this Skill for google maps email extractor on Google Maps.
...
- "Run google maps email extractor and export the results to a CSV."
- "Collect google maps email extractor data from this URL and return a table."
- "Find visible contact details using google maps email extractor for this list of targets."
- "Research these targets with google maps email extractor and return name, contact, source URL, and any visible signals."
