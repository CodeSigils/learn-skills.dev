---
name: website-schema-contact-extractor
description: "Extract structured contact data from website schema markup — email, phone, address, organization name, geo data. Use when the user wants to collect schema.org contact fields from websites."
license: MIT
metadata:
...
Use this Skill for website schema contact extractor from company websites.
...
- "Run website schema contact extractor and export the results to a CSV."
- "Collect website schema contact extractor data from this URL and return a table."
- "Find visible contact details using website schema contact extractor for this list of targets."
- "Research these targets with website schema contact extractor and return name, contact, source URL, and any visible signals."
