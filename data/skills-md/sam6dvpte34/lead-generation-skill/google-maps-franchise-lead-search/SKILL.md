---
name: google-maps-franchise-lead-search
description: "Search for franchise leads on Google Maps — franchise name, location, address, phone, website, rating. Use when the user wants to prospect franchise operators in a territory."
license: MIT
metadata:
...
Use this Skill for google maps franchise lead search on Google Maps.
...
- "Run google maps franchise lead search and export the results to a CSV."
- "Collect google maps franchise lead data from this URL and return a table."
- "Find visible contact details using google maps franchise lead search for this list of targets."
- "Research these targets with google maps franchise lead search and return name, contact, source URL, and any visible signals."
