---
name: website-about-page-lead-scraper
description: "Collect lead signals from website About pages — company description, team members, mission, founding story, contact. Use when the user wants to enrich company profiles from their About page."
license: MIT
metadata:
...
Use this Skill for website about page lead scraper from company websites.
...
- "Run website about page lead scraper and export the results to a CSV."
- "Collect website about page lead data from this URL and return a table."
- "Find visible contact details using website about page lead scraper for this list of targets."
- "Research these targets with website about page lead scraper and return name, contact, source URL, and any visible signals."
