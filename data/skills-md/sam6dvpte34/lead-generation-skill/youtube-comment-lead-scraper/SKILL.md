---
name: youtube-comment-lead-scraper
description: "Collect leads from YouTube comments — commenter name, channel link, comment text, engagement signals. Use when the user wants to prospect engaged viewers from target videos."
license: MIT
metadata:
...
Use this Skill for youtube comment lead scraper on YouTube.
...
- "Run youtube comment lead scraper and export the results to a CSV."
- "Collect youtube comment lead data from this URL and return a table."
- "Find visible contact details using youtube comment lead scraper for this list of targets."
- "Research these targets with youtube comment lead scraper and return name, contact, source URL, and any visible signals."
