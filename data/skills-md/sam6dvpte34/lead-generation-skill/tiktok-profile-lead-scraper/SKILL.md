---
name: tiktok-profile-lead-scraper
description: "Collect lead details from TikTok profiles — username, bio, follower count, website, contact signals. Use when the user wants to prospect TikTok creators or business accounts."
license: MIT
metadata:
...
Use this Skill for tiktok profile lead scraper.
...
- "Run tiktok profile lead scraper and export the results to a CSV."
- "Collect tiktok profile lead data from this URL and return a table."
- "Find visible contact details using tiktok profile lead scraper for this list of targets."
- "Research these targets with tiktok profile lead scraper and return name, contact, source URL, and any visible signals."
