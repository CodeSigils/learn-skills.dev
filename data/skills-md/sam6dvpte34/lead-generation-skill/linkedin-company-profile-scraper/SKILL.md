...
description: "Collect company profile data from LinkedIn — company name, industry, size, location, description, website. Use when the user wants to enrich a company list with LinkedIn profile details."
license: MIT
metadata:
...
Use this Skill for linkedin company profile scraper on LinkedIn.
...
- "Run linkedin company profile scraper and export the results to a CSV."
- "Collect linkedin company profile data from this URL and return a table."
- "Find visible contact details using linkedin company profile scraper for this list of targets."
- "Research these targets with linkedin company profile scraper and return name, contact, source URL, and any visible signals."
