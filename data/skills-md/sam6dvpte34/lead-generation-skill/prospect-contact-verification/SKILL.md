---
name: prospect-contact-verification
description: "Verify contact details for a prospect list — email status, phone validity, LinkedIn match, name check. Use when the user wants to validate or clean a prospect contact list."
license: MIT
metadata:
...
Use this Skill for prospect contact verification.
...
- "Run prospect contact verification and export the results to a CSV."
- "Collect prospect contact verification data from this URL and return a table."
- "Find visible contact details using prospect contact verification for this list of targets."
- "Research these targets with prospect contact verification and return name, contact, source URL, and any visible signals."
