---
name: linkedin-recruiter-job-scraper
description: "Collect job listings from LinkedIn Recruiter — job title, company, location, salary, requirements, job URL. Use when the user wants to research job market data or competitor hiring."
license: MIT
metadata:
...
Use this Skill for linkedin recruiter job scraper on LinkedIn.
...
- "Run linkedin recruiter job scraper and export the results to a CSV."
- "Collect linkedin recruiter job data from this URL and return a table."
- "Find visible contact details using linkedin recruiter job scraper for this list of targets."
- "Research these targets with linkedin recruiter job scraper and return name, contact, source URL, and any visible signals."
