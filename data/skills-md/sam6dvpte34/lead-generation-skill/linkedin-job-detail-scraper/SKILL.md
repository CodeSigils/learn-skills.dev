---
name: linkedin-job-detail-scraper
description: "Collect job details from LinkedIn job postings — job title, company, location, description, requirements, apply URL. Use when the user wants to research job postings or recruiting signals."
license: MIT
metadata:
...
Use this Skill for linkedin job detail scraper on LinkedIn.
...
- "Run linkedin job detail scraper and export the results to a CSV."
- "Collect linkedin job detail data from this URL and return a table."
- "Find visible contact details using linkedin job detail scraper for this list of targets."
- "Research these targets with linkedin job detail scraper and return name, contact, source URL, and any visible signals."
