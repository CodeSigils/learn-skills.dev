---
name: google-search-contact-scraper
description: "Collect contact details from Google Search results — name, email, phone, organization, source URL. Use when the user wants to find contact information for people or companies via search."
license: MIT
metadata:
...
# Google Search Contact Scraper

Use this Skill for google search contact scraper on Google Search.
...
- "Run google search contact scraper and export the results to a CSV."
- "Collect google contact data from this URL and return a table."
- "Find visible contact details using google search contact scraper for this list of targets."
- "Research these targets with google search contact scraper and return name, contact, source URL, and any visible signals."
