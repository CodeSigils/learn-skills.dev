---
name: linkedin-newsletter-scraper
description: "Collect newsletter data from LinkedIn — newsletter name, author, subscriber count, recent issues. Use when the user wants to prospect newsletter audiences or research content creators."
license: MIT
metadata:
...
Use this Skill for linkedin newsletter scraper on LinkedIn.
...
- "Run linkedin newsletter scraper and export the results to a CSV."
- "Collect linkedin newsletter data from this URL and return a table."
- "Find visible contact details using linkedin newsletter scraper for this list of targets."
- "Research these targets with linkedin newsletter scraper and return name, contact, source URL, and any visible signals."
