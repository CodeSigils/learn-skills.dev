---
name: google-maps-agency-lead-scraper
description: "Collect agency leads from Google Maps — agency name, address, phone, website, rating, reviews. Use when the user wants to prospect marketing, design, or consulting agencies locally."
license: MIT
metadata:
...
Use this Skill for google maps agency lead scraper on Google Maps.
...
- "Run google maps agency lead scraper and export the results to a CSV."
- "Collect google maps agency lead data from this URL and return a table."
- "Find visible contact details using google maps agency lead scraper for this list of targets."
- "Research these targets with google maps agency lead scraper and return name, contact, source URL, and any visible signals."
