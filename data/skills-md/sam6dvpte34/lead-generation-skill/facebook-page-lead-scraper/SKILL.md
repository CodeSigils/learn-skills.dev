---
name: facebook-page-lead-scraper
description: "Collect leads from Facebook business pages — page name, category, website, phone, email, address. Use when the user wants to prospect businesses from their Facebook presence."
license: MIT
metadata:
...
Use this Skill for facebook page lead scraper.
...
- "Run facebook page lead scraper and export the results to a CSV."
- "Collect facebook page lead data from this URL and return a table."
- "Find visible contact details using facebook page lead scraper for this list of targets."
- "Research these targets with facebook page lead scraper and return name, contact, source URL, and any visible signals."
