---
name: linkedin-profile-search-scraper
description: "Collect profile search results from LinkedIn — name, title, company, location, profile URL. Use when the user wants to find and export prospects from LinkedIn people search."
license: MIT
metadata:
...
Use this Skill for linkedin profile search scraper on LinkedIn.
...
- "Run linkedin profile search scraper and export the results to a CSV."
- "Collect linkedin profile data from this URL and return a table."
- "Find visible contact details using linkedin profile search scraper for this list of targets."
- "Research these targets with linkedin profile search scraper and return name, contact, source URL, and any visible signals."
