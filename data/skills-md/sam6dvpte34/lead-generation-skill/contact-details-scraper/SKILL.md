...
description: "Collect contact details from any webpage — email, phone, name, title, social profiles. Use when the user wants to extract visible contact information from a given URL."
license: MIT
metadata:
...
Use this Skill for contact details scraper.
...
- "Run contact details scraper and export the results to a CSV."
- "Collect contact details data from this URL and return a table."
- "Find visible contact details using contact details scraper for this list of targets."
- "Research these targets with contact details scraper and return name, contact, source URL, and any visible signals."
