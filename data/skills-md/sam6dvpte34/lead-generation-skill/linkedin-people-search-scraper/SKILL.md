...
description: "Collect people search results from LinkedIn — name, title, company, location, profile URL. Use when the user wants to find professionals matching specific criteria on LinkedIn."
license: MIT
metadata:
...
Use this Skill for linkedin people search scraper on LinkedIn.
...
- "Run linkedin people search scraper and export the results to a CSV."
- "Collect linkedin people data from this URL and return a table."
- "Find visible contact details using linkedin people search scraper for this list of targets."
- "Research these targets with linkedin people search scraper and return name, contact, source URL, and any visible signals."
