...
description: "Collect event details and attendee leads from LinkedIn — event name, date, host, attendees, contact signals. Use when the user wants to prospect event attendees or monitor industry events."
license: MIT
metadata:
...
Use this Skill for linkedin event scraper on LinkedIn.
...
- "Run linkedin event scraper and export the results to a CSV."
- "Collect linkedin event data from this URL and return a table."
- "Find visible contact details using linkedin event scraper for this list of targets."
- "Research these targets with linkedin event scraper and return name, contact, source URL, and any visible signals."
