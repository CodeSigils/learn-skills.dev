...
description: "Collect posts from LinkedIn company pages — post text, date, engagement, author, media type. Use when the user wants to monitor company activity or identify content signals."
license: MIT
metadata:
...
Use this Skill for linkedin company posts scraper on LinkedIn.
...
- "Run linkedin company posts scraper and export the results to a CSV."
- "Collect linkedin company posts data from this URL and return a table."
- "Find visible contact details using linkedin company posts scraper for this list of targets."
- "Research these targets with linkedin company posts scraper and return name, contact, source URL, and any visible signals."
