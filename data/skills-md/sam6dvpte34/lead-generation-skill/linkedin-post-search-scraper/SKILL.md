...
description: "Collect posts from LinkedIn search results — post text, author, date, engagement, profile URL. Use when the user wants to find content or prospects around a topic."
license: MIT
metadata:
...
Use this Skill for linkedin post search scraper on LinkedIn.
...
- "Run linkedin post search scraper and export the results to a CSV."
- "Collect linkedin post data from this URL and return a table."
- "Find visible contact details using linkedin post search scraper for this list of targets."
- "Research these targets with linkedin post search scraper and return name, contact, source URL, and any visible signals."
