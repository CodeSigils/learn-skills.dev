---
name: youtube-video-lead-scraper
description: "Collect leads from YouTube videos — video author, channel name, description, contact signals, engagement. Use when the user wants to identify prospects from relevant YouTube content."
license: MIT
metadata:
...
# YouTube Video Lead Scraper

Use this Skill for youtube video lead scraper on YouTube.
...
- "Run youtube video lead scraper and export the results to a CSV."
- "Collect youtube video lead data from this URL and return a table."
- "Find visible contact details using youtube video lead scraper for this list of targets."
- "Research these targets with youtube video lead scraper and return name, contact, source URL, and any visible signals."
