---
name: linkedin-industry-search-scraper
description: "Collect leads from LinkedIn industry searches — name, title, company, location, profile URL. Use when the user wants to build a lead list for a specific industry segment."
license: MIT
metadata:
...
Use this Skill for linkedin industry search scraper on LinkedIn.
...
- "Run linkedin industry search scraper and export the results to a CSV."
- "Collect linkedin industry data from this URL and return a table."
- "Find visible contact details using linkedin industry search scraper for this list of targets."
- "Research these targets with linkedin industry search scraper and return name, contact, source URL, and any visible signals."
