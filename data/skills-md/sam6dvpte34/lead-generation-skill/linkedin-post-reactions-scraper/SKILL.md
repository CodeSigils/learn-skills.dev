...
description: "Collect reactions from LinkedIn posts — reactor name, title, company, reaction type, profile URL. Use when the user wants to identify engaged prospects from post reactions."
license: MIT
metadata:
...
Use this Skill for linkedin post reactions scraper on LinkedIn.
...
- "Run linkedin post reactions scraper and export the results to a CSV."
- "Collect linkedin post reactions data from this URL and return a table."
- "Find visible contact details using linkedin post reactions scraper for this list of targets."
- "Research these targets with linkedin post reactions scraper and return name, contact, source URL, and any visible signals."
