---
name: google-maps-chain-location-scraper
description: "Collect chain location details from Google Maps — location name, address, phone, hours, rating. Use when the user wants to map all locations of a chain brand or franchise."
license: MIT
metadata:
...
Use this Skill for google maps chain location scraper on Google Maps.
...
- "Run google maps chain location scraper and export the results to a CSV."
- "Collect google maps chain location data from this URL and return a table."
- "Find visible contact details using google maps chain location scraper for this list of targets."
- "Research these targets with google maps chain location scraper and return name, contact, source URL, and any visible signals."
