---
name: twitter-x-search-results-lead-scraper
description: "Collect leads from Twitter/X search results — profile names, bios, follower counts, websites, contact signals. Use when the user wants to find accounts discussing a relevant topic."
license: MIT
metadata:
...
Use this Skill for twitter/x search results lead scraper.
...
- "Run twitter/x search results lead scraper and export the results to a CSV."
- "Collect twitter/x results lead data from this URL and return a table."
- "Find visible contact details using twitter/x search results lead scraper for this list of targets."
- "Research these targets with twitter/x search results lead scraper and return name, contact, source URL, and any visible signals."
