...
description: "Validate email addresses for deliverability — valid or invalid status, domain check, format check, risk level. Use when the user wants to clean an email list before outreach."
license: MIT
metadata:
...
Use this Skill for email validator.
...
- "Run email validator and export the results to a CSV."
- "Collect email validator data from this URL and return a table."
- "Find visible contact details using email validator for this list of targets."
- "Research these targets with email validator and return name, contact, source URL, and any visible signals."
