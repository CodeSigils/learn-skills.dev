---
name: google-maps-local-service-lead-scraper
description: "Collect local service business leads from Google Maps — business name, service type, address, phone, website, rating. Use when the user wants to prospect local service providers like plumbers, electricians, or cleaners."
license: MIT
metadata:
...
Use this Skill for google maps local service lead scraper on Google Maps.
...
- "Run google maps local service lead scraper and export the results to a CSV."
- "Collect google maps local service lead data from this URL and return a table."
- "Find visible contact details using google maps local service lead scraper for this list of targets."
- "Research these targets with google maps local service lead scraper and return name, contact, source URL, and any visible signals."
