---
name: github-organization-lead-scraper
description: "Collect organization leads from GitHub — org name, description, website, location, member count, contact. Use when the user wants to prospect tech organizations or open-source companies."
license: MIT
metadata:
...
Use this Skill for github organization lead scraper on GitHub.
...
- "Run github organization lead scraper and export the results to a CSV."
- "Collect github organization lead data from this URL and return a table."
- "Find visible contact details using github organization lead scraper for this list of targets."
- "Research these targets with github organization lead scraper and return name, contact, source URL, and any visible signals."
