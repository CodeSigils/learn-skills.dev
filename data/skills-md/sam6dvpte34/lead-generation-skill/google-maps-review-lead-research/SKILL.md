---
name: google-maps-review-lead-research
description: "Collect review-based leads from Google Maps — reviewer name, review text, rating, business reviewed, contact signals. Use when the user wants to research prospects from review behavior."
license: MIT
metadata:
...
Use this Skill for google maps review lead research on Google Maps.
...
- "Run google maps review lead research and export the results to a CSV."
- "Collect google maps review lead research data from this URL and return a table."
- "Find visible contact details using google maps review lead research for this list of targets."
- "Research these targets with google maps review lead research and return name, contact, source URL, and any visible signals."
