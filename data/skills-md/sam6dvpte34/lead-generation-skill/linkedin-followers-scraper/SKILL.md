---
name: linkedin-followers-scraper
description: "Collect follower leads from LinkedIn profiles or pages — follower name, title, company, profile URL. Use when the user wants to prospect people following a target individual or company."
license: MIT
metadata:
...
Use this Skill for linkedin followers scraper on LinkedIn.
...
- "Run linkedin followers scraper and export the results to a CSV."
- "Collect linkedin followers data from this URL and return a table."
- "Find visible contact details using linkedin followers scraper for this list of targets."
- "Research these targets with linkedin followers scraper and return name, contact, source URL, and any visible signals."
