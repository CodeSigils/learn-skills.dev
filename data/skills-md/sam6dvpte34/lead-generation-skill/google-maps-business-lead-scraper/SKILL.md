---
name: google-maps-business-lead-scraper
description: "Collect business leads from Google Maps — business name, address, phone, website, rating, category. Use when the user wants to build a local business lead list for any category."
license: MIT
metadata:
...
Use this Skill for google maps business lead scraper on Google Maps.
...
- "Run google maps business lead scraper and export the results to a CSV."
- "Collect google maps business lead data from this URL and return a table."
- "Find visible contact details using google maps business lead scraper for this list of targets."
- "Research these targets with google maps business lead scraper and return name, contact, source URL, and any visible signals."
