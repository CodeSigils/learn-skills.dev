...
description: "Collect employee leads from LinkedIn company pages — employee name, title, department, profile URL. Use when the user wants to map team structure or find contacts at a target company."
license: MIT
metadata:
...
Use this Skill for linkedin company employees scraper on LinkedIn.
...
- "Run linkedin company employees scraper and export the results to a CSV."
- "Collect linkedin company employees data from this URL and return a table."
- "Find visible contact details using linkedin company employees scraper for this list of targets."
- "Research these targets with linkedin company employees scraper and return name, contact, source URL, and any visible signals."
