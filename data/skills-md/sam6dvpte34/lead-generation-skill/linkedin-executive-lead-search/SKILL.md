---
name: linkedin-executive-lead-search
description: "Search for executive leads on LinkedIn — name, title, company, location, profile URL, contact signals. Use when the user wants to find C-level or VP-level contacts at target companies."
license: MIT
metadata:
...
Use this Skill for linkedin executive lead search on LinkedIn.
...
- "Run linkedin executive lead search and export the results to a CSV."
- "Collect linkedin executive lead data from this URL and return a table."
- "Find visible contact details using linkedin executive lead search for this list of targets."
- "Research these targets with linkedin executive lead search and return name, contact, source URL, and any visible signals."
