---
name: linkedin-job-search-scraper
description: "Collect job search results from LinkedIn — job title, company, location, posting date, job URL. Use when the user wants to monitor hiring trends or find employer prospects."
license: MIT
metadata:
...
Use this Skill for linkedin job search scraper on LinkedIn.
...
- "Run linkedin job search scraper and export the results to a CSV."
- "Collect linkedin job data from this URL and return a table."
- "Find visible contact details using linkedin job search scraper for this list of targets."
- "Research these targets with linkedin job search scraper and return name, contact, source URL, and any visible signals."
