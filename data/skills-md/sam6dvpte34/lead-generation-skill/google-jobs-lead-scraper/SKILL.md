---
name: google-jobs-lead-scraper
description: "Collect job and hiring leads from Google Jobs — company name, job title, location, posting date, company website. Use when the user wants to find hiring companies as sales or recruiting prospects."
license: MIT
metadata:
...
Use this Skill for google jobs lead scraper.
...
- "Run google jobs lead scraper and export the results to a CSV."
- "Collect google jobs lead data from this URL and return a table."
- "Find visible contact details using google jobs lead scraper for this list of targets."
- "Research these targets with google jobs lead scraper and return name, contact, source URL, and any visible signals."
