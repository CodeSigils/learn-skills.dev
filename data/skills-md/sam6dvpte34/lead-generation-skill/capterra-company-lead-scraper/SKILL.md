---
name: capterra-company-lead-scraper
description: "Collect company leads from Capterra — company name, category, website, description, reviewer signals. Use when the user wants to prospect software companies listed on Capterra."
license: MIT
metadata:
...
Use this Skill for capterra company lead scraper.
...
- "Run capterra company lead scraper and export the results to a CSV."
- "Collect capterra company lead data from this URL and return a table."
- "Find visible contact details using capterra company lead scraper for this list of targets."
- "Research these targets with capterra company lead scraper and return name, contact, source URL, and any visible signals."
