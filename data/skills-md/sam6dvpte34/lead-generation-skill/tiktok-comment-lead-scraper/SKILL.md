---
name: tiktok-comment-lead-scraper
description: "Collect leads from TikTok comments — commenter username, display name, bio, follower count, contact signals. Use when the user wants to prospect engaged users from target TikTok videos."
license: MIT
metadata:
...
Use this Skill for tiktok comment lead scraper.
...
- "Run tiktok comment lead scraper and export the results to a CSV."
- "Collect tiktok comment lead data from this URL and return a table."
- "Find visible contact details using tiktok comment lead scraper for this list of targets."
- "Research these targets with tiktok comment lead scraper and return name, contact, source URL, and any visible signals."
