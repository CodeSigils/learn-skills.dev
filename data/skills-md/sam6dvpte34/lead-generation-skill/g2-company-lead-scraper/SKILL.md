---
name: g2-company-lead-scraper
description: "Collect company leads from G2 — company name, category, website, description, reviewer signals. Use when the user wants to prospect software companies listed on G2."
license: MIT
metadata:
...
Use this Skill for g2 company lead scraper.
...
- "Run g2 company lead scraper and export the results to a CSV."
- "Collect g2 company lead data from this URL and return a table."
- "Find visible contact details using g2 company lead scraper for this list of targets."
- "Research these targets with g2 company lead scraper and return name, contact, source URL, and any visible signals."
