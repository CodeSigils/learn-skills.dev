---
name: tiktok-follower-lead-scraper
description: "Collect follower leads from TikTok profiles — follower username, display name, bio, contact signals. Use when the user wants to prospect followers of a target TikTok account."
license: MIT
metadata:
...
Use this Skill for tiktok follower lead scraper.
...
- "Run tiktok follower lead scraper and export the results to a CSV."
- "Collect tiktok follower lead data from this URL and return a table."
- "Find visible contact details using tiktok follower lead scraper for this list of targets."
- "Research these targets with tiktok follower lead scraper and return name, contact, source URL, and any visible signals."
