---
name: facebook-ad-library-intent-scraper
description: "Collect ad intent signals from Facebook Ad Library — advertiser, ad copy, CTA, offer type, industry. Use when the user wants to identify companies actively running Facebook ads as buyer intent signals."
license: MIT
metadata:
...
Use this Skill for facebook ad library intent scraper.
...
- "Run facebook ad library intent scraper and export the results to a CSV."
- "Collect facebook ad library intent data from this URL and return a table."
- "Find visible contact details using facebook ad library intent scraper for this list of targets."
- "Research these targets with facebook ad library intent scraper and return name, contact, source URL, and any visible signals."
