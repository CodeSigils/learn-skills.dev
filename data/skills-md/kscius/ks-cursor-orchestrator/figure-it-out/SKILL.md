...
- /figure-it-out, 'figure it out', a large migration, or when no narrower playbook applies

> **On-demand loading:** Read this file when the task matches the triggers below.

> **Activation:** Use this skill when the task is large, cross-cutting, or matches no existing narrower playbook — trigger phrases: `/figure-it-out`, "figure it out", large migrations, ambitious multi-part changes, or work reviewed after stepping away. Do NOT use when a focused single-unit playbook (bugfix, feature, perf) already fits.
