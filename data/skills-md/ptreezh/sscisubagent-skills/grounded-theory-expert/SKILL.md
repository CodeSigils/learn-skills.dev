...
license: MIT
tags: [grounded-theory, open-coding, axial-coding, selective-coding, memo-writing, saturation-analysis, qualitative-research, planning-with-files]
...
- 中文质性数据的扎根理论分析
- 需要系统性规划和进度跟踪的扎根理论研究
- 集成planning-with-files进行项目管理的质性研究
...
- **选择式编码**: 核心范畴和理论构建
- **饱和度检验**: 理论完整性的验证
- **项目规划**: 与planning-with-files集成的项目规划
...
- **质量检查**: 扎根理论分析的质量控制
- **理论评估**: 构建理论的有效性评估
- **进度跟踪**: 基于planning-with-files的进度监控
...
- **多数据源分析**: 多个数据源的整合分析
- **理论比较**: 不同理论框架的比较分析
- **集成规划**: 完整的planning-with-files工作流集成
...
- `analysis_type`: 分析类型 (reliability-validity, concept-relationship, saturation-trends)
