...
license: MIT
tags: [actor-network-theory, ANT, science-technology-studies, socio-technical, networks, planning-with-files]
...
# 行动者网络理论分析技能 (Actor-Network Theory Analysis)

## 概述

行动者网络理论(ANT)分析技能为社会科学研究提供分析异质性行动者网络、追踪转译过程和理解技术社会互动的框架。该技能帮助研究者识别人类和非人类行动者、构建关系网络、追踪网络构建过程并分析网络动态。
...
- 科学知识构建过程的调查
- 需要系统性规划和进度跟踪的ANT研究
- 集成planning-with-files进行项目管理的网络分析
...
*此技能为行动者网络理论分析提供专业的框架和工具，确保研究的科学性和严谨性。*