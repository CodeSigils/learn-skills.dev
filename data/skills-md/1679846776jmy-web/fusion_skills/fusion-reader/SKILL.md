...
Build the Terminology Ledger as you translate (`../fusion-shared/core/terminology-ledger.md`); it becomes the `paper.md` recurring-term table and the `source_map.json` glossary. For fusion papers, also highlight fusion terminology, extract standard plasma parameters (I_p, B_t, n_e, T_e, q_95, β_N, τ_E), and associate the paper with its machine (`../fusion-shared/core/machine-database.md`); see `references/fusion-paper-anatomy.md` and `references/fusion-parameter-extraction.md`.
...
- fusion paper structure (abstract device/discharge/diagnostic triad, experiment vs results sections) → `references/fusion-paper-anatomy.md`.
- extracting standard plasma parameters (I_p, B_t, n_e, T_e, q_95, β_N, τ_E) → `references/fusion-parameter-extraction.md`.
...
- This structure mirrors `fusion-writing` and `fusion-polishing` so shared content lives in `fusion-shared/`.
