---
name: fusion-response
description: >-
  Draft, audit, or revise fusion-journal-style revision correspondence packages: point-by-point
...
# Fusion Reviewer Response — Router
...
Unlike fusion-writing or fusion-figure, fusion-response has no fragment axis. Its variation is identified at runtime, not by loading different content bodies:
...
- This structure mirrors `fusion-writing`, `fusion-polishing`, `fusion-reader`, `fusion-figure`, and `fusion-academic-search`.
