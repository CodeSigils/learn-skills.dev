...
2. **UI Design**: Use `junli-shadcn-ui`, the `shadcn-ui` skill, for page design, component styling, and visual direction
3. **Authentication**: Read the `auth-web` and `auth-tool` skills - Use Web SDK built-in authentication
4. **Database**:
...
2. **UI Design**: Use `junli-shadcn-ui`, the `shadcn-ui` skill, for page design, component styling, and visual direction
3. **Authentication**: Read the `references/auth-wechat/SKILL.md` skill - Naturally login-free, get OPENID in cloud functions
4. **Database**:
...
- `junli-shadcn-ui` (`shadcn-ui`) - UI design, component styling, and visual direction
