...
5. Observe RED first: record the failing command, exit code, test name, and the relationship between the failure and the target risk. If the test passes immediately, stop and prove it can fail for the target risk.
